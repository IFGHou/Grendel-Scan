...
public class Urls
{
    ...
    public static boolean isRemote(final java.net.URL url)
    {
        String scheme = url.getProtocol();
        return "http".equalsIgnoreCase(scheme) || "https".equalsIgnoreCase(scheme) || "ftp".equalsIgnoreCase(scheme) || "file".equalsIgnoreCase(scheme) && hasHost(url);
    }

    /*
     * TODO UCdetector: Remove unused code: public static boolean isLocalFile(java.net.URL url) { String scheme = url.getProtocol(); return "file".equalsIgnoreCase(scheme) && !hasHost(url); }
     */
