...
public class Strings
{
    ...
    public static String getMD5(final String source) throws UnsupportedEncodingException
    {
    ...
    public static String getTextFromStream(final InputStream in) throws IOException
    {
    ...
    public static String strictHtmlEncode(final String rawText)
    {
