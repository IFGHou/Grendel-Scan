...
/**
 * The <code>InputSourceImpl</code> class implements the <code>InputSource</code> interface.
 * 
 * @author J. H. S.
 */
public class InputSourceImpl extends InputSource
{
     ...
     */
    public InputSourceImpl(final InputStream byteStream, final String uri, String charset)
    {
        super(byteStream);
        if (charset.isEmpty())
        {
