...
public class HTMLBlockQuoteElementImpl extends HTMLAbstractUIElement
{
    ...
    public HTMLBlockQuoteElementImpl(final String name, final int transactionId)
    {
        super(name, transactionId);
    }

    /*
     * protected RenderState createRenderState(RenderState prevRenderState) { return new BlockRenderState(prevRenderState, this); }
     */
}
