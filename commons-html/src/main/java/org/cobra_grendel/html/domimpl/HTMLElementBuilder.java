...
public abstract class HTMLElementBuilder
{
    ...
    {
        @Override
        public HTMLElementImpl build(final String name, final int transactionId)
        {
    ...
    /*
     * TODO UCdetector: Remove unused code: public static class GenericMarkup extends HTMLElementBuilder {
     * 
     * @Override public HTMLElementImpl build(String name, transactionId) { return new HTMLGenericMarkupElement(name, transactionId); } }
     */
    ...
    public final HTMLElement create(final HTMLDocument document, final String name, final int transactionId)
    {
