 ...
 * the node's <code>name</code> or <code>id</code> attributes. Collections
...
public interface HTMLOptionsCollection
{
	 ...
	 * only on those elements that are allowed a name attribute. This method is
	 * case insensitive in HTML documents and case sensitive in XHTML documents.
	 * 
	 * @param name
