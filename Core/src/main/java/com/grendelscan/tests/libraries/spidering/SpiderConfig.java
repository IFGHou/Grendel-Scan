...
public class SpiderConfig
{
	...
	public static void initialize() 
	{
		...
		oncePerUrl = new SelectableOption("Once per URL", true, "Spider each URL once, regardless of query parameters. " +
				"This will usually be the best option, unless a single URL is used for many purposes.", null);
		allParamNames = new SelectableOption("All params names", false, "Request each uniqe set of URL query parameter names once, but ignore the values. " +
				"Slower, but more thorough. Only use if needed.", null);
