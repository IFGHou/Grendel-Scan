...
public class SingleQuoteQuery extends TestModule implements ByRequestDataLocationTest
{
	...
	private StandardHttpTransaction runTestTransaction(StandardHttpTransaction transaction, ByteData queryDatum, String attack, int testJobId) throws UnrequestableTransaction, InterruptedScanException
	{
		StandardHttpTransaction testTransaction = transaction.cloneFullRequest(TransactionSource.MISC_TEST, testJobId);
		ByteData testTransactionQueryDatum = (ByteData) DataContainerUtils.resolveReferenceChain(
