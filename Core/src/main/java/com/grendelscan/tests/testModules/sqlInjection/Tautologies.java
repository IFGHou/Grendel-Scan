...
public class Tautologies extends TestModule implements ByRequestDataLocationTest
{
	@Override
			...
			String antiTautology, boolean binary, int testJobId) throws UnrequestableTransaction, InterruptedScanException
	{
		...
		ByteData firstTautologyData = (ByteData) DataContainerUtils.resolveReferenceChain(
