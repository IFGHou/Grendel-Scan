...
public class HexEncodingUtils
{
    ...
    public static byte[] simplifyHexFormat(byte[] data)
	{
	...
	public static byte[] decodeHex(byte[] data) throws DataFormatException
	{
		try
		{
	...
	public static byte[] encodeHex(byte[] data, byte[] toDigits, boolean zero_prefix, boolean slash_x) 
	{
