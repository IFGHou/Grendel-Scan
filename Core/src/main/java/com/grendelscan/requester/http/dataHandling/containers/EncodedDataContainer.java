...
public class EncodedDataContainer extends AbstractData implements DataContainer<SingleChildReference>
{
	 ...
	 */
	public EncodedDataContainer(DataContainer<?> parent, byte[] encodedData, DataFormat format, int transactionId, boolean mutableChildren) throws DataFormatException
	{
