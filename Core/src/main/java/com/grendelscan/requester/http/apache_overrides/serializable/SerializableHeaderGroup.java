...
public class SerializableHeaderGroup implements Serializable
{
	 ...
	 */
	private List<SerializableHttpHeader> headers;
	...
	/**
	 * Replaces the first occurence of the header with the same name. If no
	 * header with the same name is found the given header is added to the end
	 * of the list.
	 * 
	 * @param header
	 *            the new header that should replace the first header with the
	 *            same name if present in the list.
	 */
