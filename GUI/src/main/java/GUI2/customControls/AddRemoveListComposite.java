...
public class AddRemoveListComposite extends GComposite
{
	...
	private void initGUI(String titleText)
	{
		...
		groupComposite.setLayout(new FormLayout());
		{
			...
			itemTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false,
					false));
		}
		{
			...
			buttonComposite.setLayoutData(buttonCompositeLData);
			{
				...
				itemAddButton.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
						false, false));
			...
			}
			{
				...
				itemRemoveButton.setFontf(GUIConstants.getFont(0));
		...
		}
		{
			...
			itemList.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
		}
		this.layout();
	}
