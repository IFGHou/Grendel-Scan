...
*/
public class PresetStringComposite extends com.grendelscan.GUI.customControls.basic.GComposite implements FuzzVectorComposite
{
	...
	public PresetStringComposite(com.grendelscan.GUI.customControls.basic.GComposite parent, int style) {
		super(parent, style);
		initGUI();
	}
