package com.grendelscan.GUI2.fuzzing;
...
public class FuzzerComposite extends com.grendelscan.GUI.customControls.basic.GComposite implements GrendelSettingsControl{
	...
	public FuzzerComposite(com.grendelscan.GUI.customControls.basic.GComposite parent, int style) {
		super(parent, style);
