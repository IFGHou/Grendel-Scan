...
public class ProxyBindingsComposite extends com.grendelscan.GUI.customControls.basic.GComposite implements GrendelSettingsControl{
...
//	protected GText maxProxyThreadTextBox;
	...
	public ProxyBindingsComposite(com.grendelscan.GUI.customControls.basic.GComposite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
			this.setLayout(new FormLayout());
			{
				...
				mainProxySettingsGroup.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
...
//					}
			...
			
			{
				...
				reverseProxySettingsGroup.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
				FormData groupLayoutData = new FormData();
				groupLayoutData.left =  new FormAttachment(0, 1000, 5);
				...
				reverseProxySettingsGroup.setLayoutData(groupLayoutData);
				{
					...
					reverseProxySettingsComposite.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
