package com.grendelscan.GUI2.actionComposites;
...
*/
public class ManualRequestComposite extends com.grendelscan.GUI.customControls.basic.GComposite {
	...
	public ManualRequestComposite(com.grendelscan.GUI.customControls.basic.GComposite parent, int style) {
		super(parent, style);
