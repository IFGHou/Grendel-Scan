package com.grendelscan.GUI2.statusComposites;
...
public class LogComposite extends com.grendelscan.GUI.customControls.basic.GComposite
{
	...
	private void initGUI()
	{
			...
			queueSizeGroup.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
					false, false));
			{
				...
				testerQueueSizeTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
			...
			}
			{
				...
				testQueueLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
						false, false));
			}
			{
				...
				categorizerQueueSizeTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
						GUIConstants.fontSize, 0, false, false));
			}
			{
				...
				requesterQueueSizeTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
						GUIConstants.fontSize, 0, false, false));
			}
			{
				...
				requesterQueueLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
						GUIConstants.fontSize, 0, false, false));
			}
			{
				...
				categorizerQueueLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
						GUIConstants.fontSize, 0, false, false));
			}
			{
				scanStatusTextArea =
				...
				scanStatusTextArea.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
						false, false));
			}
