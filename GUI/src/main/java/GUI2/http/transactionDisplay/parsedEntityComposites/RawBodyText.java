...
{
	private GText textBox;
	
	public RawBodyText(GComposite parent, int style)
	{
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addControlListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addDisposeListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addDragDetectListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addHelpListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addListener(eventType, listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addMenuDetectListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addMouseMoveListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addMouseTrackListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addMouseWheelListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addPaintListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addSelectionListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addTraverseListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.addVerifyListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    return textBox.computeSize(hint, hint2, changed);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    return textBox.computeSize(hint, hint2);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    return textBox.computeTrim(x, y, width, height);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    return textBox.dragDetect(event);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.internal_dispose_GC(hdc, data);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    return textBox.internal_new_GC(data);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    return textBox.isListening(eventType);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.notifyListeners(eventType, event);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.redraw(x, y, width, height, all);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeControlListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeDisposeListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeDragDetectListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeHelpListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeListener(eventType, listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeMenuDetectListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeModifyListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeMouseListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeMouseMoveListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeMouseTrackListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeMouseWheelListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removePaintListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeSelectionListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeTraverseListener(listener);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    textBox.removeVerifyListener(listener);
    }
*/
...
*/
	...
	public void setFontf(Font font)
    {
	    textBox.setFontf(font);
    }
	...
	public boolean setParent(GComposite parent)
    {
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    return textBox.toControl(point);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    return textBox.toDisplay(point);
    }
*/
...
/* TODO UCdetector: Remove unused code: 
    ...
    {
	    return textBox.traverse(traversal);
    }
*/
