package com.grendelscan.GUI2.http.interception;
import java.io.File;
...
*/
public class InterceptionComposite extends com.grendelscan.GUI.customControls.basic.GComposite {
	...
	InterceptionComposite(GComposite parent, int style, StandardHttpTransaction transaction, boolean requestOnly) 
	{
		super(parent, style);
		this.transaction = transaction;
		this.requestOnly = requestOnly;
