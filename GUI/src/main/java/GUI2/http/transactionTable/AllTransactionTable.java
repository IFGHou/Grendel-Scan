...
public class AllTransactionTable extends AbstractTransactionTable
{
	...
	protected int initGUIStart(int top)
	{
		...
		}
		{
			...
			transactionCountLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
		}
		{
			...
			transactionCountTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
		}
		return top;
	}
