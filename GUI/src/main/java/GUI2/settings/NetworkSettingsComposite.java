 ...
 */
public class NetworkSettingsComposite extends com.grendelscan.GUI.customControls.basic.GComposite implements
		GrendelSettingsControl
{
	...
	public NetworkSettingsComposite(com.grendelscan.GUI.customControls.basic.GComposite parent, int style)
	{
		super(parent, style);
		initGUI();
	}
...
//		}
		{
			...
			upstreamProxyGroup.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
						false, false));
			FormData upstreamProxyGroupLData = new FormData();
			upstreamProxyGroupLData.width = 448;
			upstreamProxyGroupLData.height = 183;
...

		{
			...
			socksProxyGroup.setLayout(null);
			{
				...
				useSocksProxyCheckBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			...
			}
			{
				...
				socksProxyAddressLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			}
			{
				...
				socksProxyPortLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			}
			{
				socksProxyAddressTextBox = new GText(socksProxyGroup, SWT.BORDER);
				socksProxyAddressTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
				socksProxyAddressTextBox.setBounds(86, 52, 301, 25);
			}
			{
				socksProxyPortTextBox = new GText(socksProxyGroup, SWT.BORDER);
				socksProxyPortTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
		...
		}		
		{
			...
			httpClientLimitsGroup.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize,
						0, false, false));
			...
			httpClientLimitsGroup.setLayout(null);
			{
				...
				maxRequestsPerSecondLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			}
			{
				maxRequestsPerSecondTextBox = new GText(httpClientLimitsGroup, SWT.BORDER);
				maxRequestsPerSecondTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			...
			}
			{
				...
				maxConnectionsPerServerLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			}
			{
				...
				maxTotalConnectionsLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			}
			{
				maxConnectionsPerServerTextBox = new GText(httpClientLimitsGroup, SWT.BORDER);
				maxConnectionsPerServerTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			...
			}
			{
				...
				maxTotalConnectionsTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			...
			}
			{
				...
				maxConsecutiveFailedRequestsLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			}
			{
				maxConsecutiveFailedRequestsTextBox = new GText(httpClientLimitsGroup, SWT.BORDER);
				maxConsecutiveFailedRequestsTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			...
			}
			{
				...
				maxFailedRequestsPerServerLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			}
			{
				maxFailedRequestsPerServerTextBox = new GText(httpClientLimitsGroup, SWT.BORDER);
				maxFailedRequestsPerServerTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			...
			}
			{
				...
				socketReadTimeoutLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			}
			{
				socketReadTimeoutTextBox = new GText(httpClientLimitsGroup, SWT.BORDER);
				socketReadTimeoutTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			...
			// }
			{
				...
				maxFileSizeLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize,
							0, false, false));
			}
			{
				maxFileSizeTextBox = new GText(httpClientLimitsGroup, SWT.BORDER);
				maxFileSizeTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize,
							0, false, false));
	...
	{
		return Scan.getScanSettings();
	}
	
	protected DataBindingContext initDataBindings() {
		DataBindingContext bindingContext = new DataBindingContext();
		//
		IObservableValue observeEnabledUseUpstreamProxyCheckBoxObserveWidget = WidgetProperties.enabled().observe(useUpstreamProxyCheckBox);
		IObservableValue useUpstreamProxyGetScanSettingsObserveValue = PojoProperties.value("useUpstreamProxy").observe(getScanSettings());
		bindingContext.bindValue(observeEnabledUseUpstreamProxyCheckBoxObserveWidget, useUpstreamProxyGetScanSettingsObserveValue, null, null);
		//
		IObservableValue observeTextMaxRequestsPerSecondTextBoxObserveWidget = WidgetProperties.text(SWT.Modify).observe(maxRequestsPerSecondTextBox);
		IObservableValue maxRequestsPerSecondGetScanSettingsObserveValue = PojoProperties.value("maxRequestsPerSecond").observe(getScanSettings());
		bindingContext.bindValue(observeTextMaxRequestsPerSecondTextBoxObserveWidget, maxRequestsPerSecondGetScanSettingsObserveValue, null, null);
		//
