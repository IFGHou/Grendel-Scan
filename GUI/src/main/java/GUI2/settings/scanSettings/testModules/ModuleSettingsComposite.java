...
*/
public class ModuleSettingsComposite extends com.grendelscan.GUI.customControls.basic.GComposite implements GrendelSettingsControl{
	...
	*/	
	...
	public ModuleSettingsComposite(com.grendelscan.GUI.customControls.basic.GComposite parent, int style) {
		super(parent, style);
		initGUI();
	}
			...
			{
				{
					...
					testModuleTabSashForm.setBounds(0, 0, 875, 557);
					{
						...
						}
						{
							...
							testModuleTree.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,GUIConstants.fontSize,0,false,false));
					...
					}
					{
						...
						testModuleDetailsSashForm.setLayout(new GridLayout());
						{
							...
							testModuleDescriptionComposite.setLayout(testModuleDescriptionCompositeLayout);
							{
								...
								testModuleDescriptionTextArea.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,GUIConstants.fontSize,0,false,false));
...
//								testModuleSettingsComposite.setBounds(0, 0, 525, 30);
	...
	protected void populateTestModuleSettings(TestModule module)
	{
		...
		if (module != null)
		{
			...
			if (module.getConfigurationOptions().size() == 0)
			{
				...
				defaultLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
	...
	protected void makeTextListOption(final TextListOption option, GComposite parent)
	{
		...
		list.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
...
//		list.setLayoutData(text1LData);
	...
	protected void makeExperimentalText(String statusText, GComposite parent)
	{
		
		GLabel label = new GLabel(parent, SWT.NONE);
		label.setText("Experimental status:");
		label.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
		
		int style = SWT.BORDER | SWT.MULTI | SWT.WRAP | SWT.READ_ONLY | SWT.V_SCROLL;
		GText textBox = new GText(parent, style);
		textBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
...
//		textBox.setLayoutData(text1LData);
	...
	protected void makeIntegerOptionGUI(IntegerOption option, GComposite parent)
	{
		makeOptionLabel(option, parent);
...
//		textBox.setLayoutData(text1LData);
	...
	protected void makeTextOptionGUI(TextOption option, GComposite parent)
	{
		makeOptionLabel(option, parent);
...
//		textBox.setLayoutData(text1LData);
	...
	protected void makeGroupOptionGUI(OptionGroup option, GComposite parent)
	{
		GGroup group = new GGroup(parent, SWT.NONE);
		group.setText(((ConfigurationOption) option).getName());
		group.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
	...
	protected void makeOptionLabel(ConfigurationOption option, GComposite parent)
	{
		GLabel label = new GLabel(parent, SWT.NONE);
	 ...
	 */
	protected void makeSelectableOptionGUI(SelectableOption option, GComposite parent, boolean checkBox)
	{
		int style = SWT.LEFT;
		if (checkBox)
		{
		...
		button.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
	...
	protected void makeFileNameOption(FileNameOption option, GComposite parent)
	{
		makeOptionLabel(option, parent);
		GText filenameTextBox = new GText(parent, SWT.BORDER);
		filenameTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
...
//		filenameTextBox.setLayoutData(text1LData);
		...
		filenameBrowseButton.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
