 ...
 */
public class AuthenticationSettingsComposite extends com.grendelscan.GUI.customControls.basic.GComposite implements
...
//	protected FormData 		passwordTextBoxLData;
	...
	public AuthenticationSettingsComposite(com.grendelscan.GUI.customControls.basic.GComposite parent, int style)
	{
		super(parent, style);
		initGUI();
	}
	...
	{
		{
			...
			}
			{
				...
				useAuthenticationCheckBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
			...
			}
			{
				...
				automaticAuthenticationDetectionCheckBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
						GUIConstants.fontSize, 0, false, false));
			...
			
			{
				...
				useDomainCheckbox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
						false, false));
			...
			}
			{
				...
				accountsGroup.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
						false, false));
				...
				accountsGroup.setLayout(accountsGroupLayout);
				{
					...
					showPasswordsCheckbox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
					showPasswordsCheckbox.addSelectionListener(new SelectionAdapter()
					{
						...
						public void widgetSelected(@SuppressWarnings("unused") SelectionEvent event)
						{
							...
							for (GTableItem item : accountsTable.getItems())
								{
									String pass;
				...
				}
				{
					...
					usernameLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
							false, false));
				}
				{
					...
					usernameTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
							false, false));
				}
				{
					...
					passwordLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
							false, false));
				}
//				{
...
//				}
				{
					...
					domainLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
							false, false));
				}
				{
					domainTextBox = new GText(accountsGroup, SWT.BORDER);
					domainTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
							false, false));
				...
				}
				{
					...
					accountAddButton.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize,
							0, false, false));
				...
				}
				{
					...
					accountRemoveButton.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
					accountRemoveButton.addSelectionListener(new SelectionAdapter()
					{
						...
						public void widgetSelected(@SuppressWarnings("unused") SelectionEvent event)
						{
							for (GTableItem item : accountsTable.getSelection())
								{
				...
				}
				{
					...
					accountsTable.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
							false, false));
			...
			}
			{
				...
				formAuthenticationGroup.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
						GUIConstants.fontSize, 0, false, false));
				...
				}
				{
					...
					authenticationUrlTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
				}
				{
					...
					httpMethodGroup.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
							false, false));
					{
						...
						httpGetRadio.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize,
								0, false, false));
					}
					{
						...
						httpPostRadio.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize,
								0, false, false));
				...
				}
				{
					...
					usernameFieldTextbox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
				}
				{
					...
					usernameFieldLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize,
							0, false, false));
				}
				{
					...
					passwordFieldLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize,
							0, false, false));
				}
				{
					...
					passwordFieldTextbox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
				}
				{
					...
					domainFieldLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize,
							0, false, false));
				}
				{
					domainFieldTextbox = new GText(formAuthenticationGroup, SWT.BORDER);
					domainFieldTextbox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize,
							0, false, false));
				...
				}
				{
					...
					postQueryLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
							false, false));
				}
				{
					postQueryTextbox = new GText(formAuthenticationGroup, SWT.BORDER);
					postQueryTextbox.setText("");
					postQueryTextbox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize,
							0, false, false));
				...
				}
				{
					...
					authenticationUrlLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
				}
				createPasswordTextBox();
			}
	...
	protected void createPasswordTextBox()
	{
		...
		passwordTextBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false,
				false));
	}
	...
	public String updateToSettings()
	{
		...
		for (GTableItem tempItem:  accountsTable.getItems())
		{
