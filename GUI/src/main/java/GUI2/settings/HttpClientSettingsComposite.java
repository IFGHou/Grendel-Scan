...
public class HttpClientSettingsComposite extends com.grendelscan.GUI.customControls.basic.GComposite implements GrendelSettingsControl
{
	...
	private void initGUI()
	{
		...
		}
		{
			...
			miscHttpClientGroup.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
						false, false));
			...
			miscHttpClientGroup.setLayout(miscHttpClientGroupLayout);
			{
				...
				useragentComboBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize,
							0, false, false));
			...
			}
			{
				...
				useragentLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
							false, false));
			}
		}
		{
			...
			responseCodeGroup.setFontf(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0,
						false, false));
			...
			responseCodeGroup.setLayout(responseCodeGroupLayout);
			{
				...
				useAutomaticOverridesCheckBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
			...
			}
			{
				...
				testEveryDirectoryCheckBox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			...
			}
			{
				...
				manualOverrideCodeLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			}
			{
				...
				manualOverrideRegexLabel.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			}
			{
				httpResponseCodeTextbox = new GText(responseCodeGroup, SWT.BORDER);
				httpResponseCodeTextbox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			...
			}
			{
				...
				regexOverrideTextbox.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			...
			}
			{
				...
				manualOverrideAddButton.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			...
			}
			{
				...
				manualOverrideRemoveButton.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
			...
			}
			{
				...
				responseCodeOverrideTable.setFontf(SWTResourceManager.getFont(GUIConstants.fontName,
							GUIConstants.fontSize, 0, false, false));
