...
//	private boolean showNextButtons;
	...
	public TransactionComposite(GSashForm parent, int style, boolean requestEditable, boolean responseEditable, 
	...
	public TransactionComposite(GShell parent, int style, boolean requestEditable, boolean responseEditable, 
			boolean showResponse) 
	{
		super(parent, style);
		this.requestEditable = requestEditable;
