...
import com.grendelscan.GUI.customControls.basic.GScrolledComposite;
import com.grendelscan.GUI.customControls.basic.GText;
import com.grendelscan.GUI.customControls.basic.GTree;
import com.grendelscan.GUI.customControls.basic.GTreeItem;
...
//								testModuleSettingsComposite.setBounds(0, 0, 525, 30);
	...
	void changeCheckChildren(TreeItem child2, boolean checked) throws ModuleDependencyException
	{
		...
		if (child2.getData() instanceof TestModule)
		{
			TestModule module = (TestModule) child2.getData();
			if (checked)
			{
