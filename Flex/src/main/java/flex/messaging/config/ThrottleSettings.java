...
public class ThrottleSettings
{
    ...
    /**
     * Integer value of replace policy. Note that replace policy is currently
     * not used, and functionally the same as ignore policy.
     */
     ...
     * IGNORE, or REPLACE. Note that replace policy is currently not used,
     * and functionally the same as ignore policy.
     *
    ...
    public void setIncomingClientFrequency(int n)
    {
        ...
        {
            ConfigurationException ex = new ConfigurationException();
            ex.setMessage("The incoming client frequency '" + n
                    + "' cannot be more than the incoming destination frequency '"
                    + inDestinationMessagesPerSec + "'");
            throw ex;
        }
    ...
    public void setIncomingDestinationFrequency(int n)
    {
        ...
        {
            ConfigurationException ex = new ConfigurationException();
            ex.setMessage("The incoming destination frequency '" + n
                    + "' cannot be less than the incoming client frequency '"
                    + inClientMessagesPerSec + "'");
            throw ex;
        }
    ...
    public void setOutgoingClientFrequency(int n)
    {
        ...
        {
            ConfigurationException ex = new ConfigurationException();
            ex.setMessage("The outgoing client frequency '" + n
                    + "' cannot be more than the outgoing destination frequency '"
                    + outDestinationMessagesPerSec + "'");
            throw ex;
        }
    ...
    public void setOutgoingDestinationFrequency(int n)
    {
        ...
        {
            ConfigurationException ex = new ConfigurationException();
            ex.setMessage("The outgoing destination frequency '" + n
                    + "' cannot be less than the outgoing client frequency '"
                    + outClientMessagesPerSec + "'");
            throw ex;
        }
