...
public class EndpointPushNotifier extends TimeoutAbstractObject implements EndpointPushHandler, FlexSessionListener, MessageClientListener
{
     ...
     */
    @Override public void close(boolean disconnectChannel)
    {        
        synchronized (lock)
        {
            if (closed || closing)
     ...
     */
    @Override public void pushMessages(List messagesToPush)
    {
     ...
     */
    @Override public void registerMessageClient(MessageClient messageClient)
    {
     ...
     */
    @Override public void sessionCreated(FlexSession flexSession)
    {
        // No-op.
    }
     ...
     */
    @Override public void sessionDestroyed(FlexSession flexSession)
    {
        if (Log.isInfo())
     ...
     */
    @Override public void unregisterMessageClient(MessageClient messageClient)
    {
        if (messageClient != null)
        {
