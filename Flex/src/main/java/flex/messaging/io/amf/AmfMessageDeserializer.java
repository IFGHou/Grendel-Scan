...
public class AmfMessageDeserializer implements MessageDeserializer
{
     ...
     */
    @Override public void initialize(SerializationContext context, InputStream in, AmfTrace trace)
    {
     ...
     */
    @Override public void readMessage(ActionMessage m, ActionContext context) throws ClassNotFoundException, IOException
    {
        if (isDebug)
