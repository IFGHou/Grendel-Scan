...
public class MessageBrokerControl extends BaseControl implements MessageBrokerControlMBean
{
     ...
     */
    @Override public ObjectName[] getEndpoints() throws IOException
    {
     ...
     */
    @Override public ObjectName[] getServices() throws IOException
    {
     ...
     */
    @Override public Integer getFlexSessionCount()
    {
     ...
     */
    @Override public Integer getMaxFlexSessionsInCurrentHour()
    {
     ...
     */
    @Override public Integer getEnterpriseConnectionCount() throws IOException
    {
        int connections = 0;
    /*
    ...
    */
     ...
     */
    @Override public Long getAMFThroughput() throws IOException
    {
     ...
     */
    @Override public Long getHTTPThroughput() throws IOException
    {
     ...
     */
    @Override public Long getEnterpriseThroughput() throws IOException
    {
     ...
     */
    @Override public Long getStreamingAMFThroughput() throws IOException
    {
     ...
     */
    @Override public Long getStreamingHTTPThroughput() throws IOException
    {
