...
public class FlexClientManagerControl extends BaseControl implements FlexClientManagerControlMBean
{
     ...
     */
    @Override public String[] getClientIds() 
    {
     ...
     */
    @Override public Long getClientLastUse(String clientId)
    {
     ...
     */
    @Override public Integer getClientSessionCount(String clientId)
    {
     ...
     */
    @Override public Integer getClientSubscriptionCount(String clientId)
    {
     ...
     */
    @Override public Integer getFlexClientCount() 
    {
