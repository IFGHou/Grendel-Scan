...
public interface HTMLInputElement extends HTMLElement
{
	 ...
	 * "radio" or "checkbox", some implementations may change the value of this
	 * property before the event is being dispatched in the document. If the
	 * default action of the event is canceled, the value of the property may be
	 * changed back to its original value. This means that the value of this
	 * property during the handling of click events is implementation dependent.
	 */
	...
	/**
	 * When the <code>type</code> attribute of the element has the value
	 * "text", "file" or "password", this represents the HTML value attribute of
	 * the element. The value of this attribute does not change if the contents
	 * of the corresponding form control, in an interactive user agent, changes.
	...
	/**
	 * When the <code>type</code> attribute of the element has the value
	 * "text", "file" or "password", this represents the current contents of the
