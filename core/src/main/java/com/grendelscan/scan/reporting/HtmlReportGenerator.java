...
public class HtmlReportGenerator extends ReportGenerator
{
    ...
    public HtmlReportGenerator(final String reportFilename, final FindingSeverity minSeverity)
    {
    ...
    public void generateReport()
    {
        ...
        String reportString = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">" + newLine + "<html xmlns=\"http://www.w3.org/1999/xhtml\" >" + newLine
                        + "<head><title>Grendel-Scan Report: " + dateString + "</title>" + newLine + "<style type=\"text/css\"> " + newLine + "BODY { word-wrap: break-word; font-family: Arial; font-size: 10pt; } " + newLine
        ...
        reportString += "<body><table style=\"width: 800px\"><tr><td style=\"text-align: center; font-size: 16pt;\">Grendel-Scan Report<br />" + "<div style=\"font-size: 14pt\">" + dateString + "</div><br /></td></tr>";
        while (isMoreEvents())
        {
            event = getNextEvent();
