...
//import com.grendelscan.smashers.utils.TokenTesting.TokenContext;
//import com.grendelscan.smashers.utils.TokenTesting.TokenTesting;
...
//
//public class ErrorXSS extends AbstractSmasher implements ByHostTest, ByBaseUriTest
//{
//
//	
//
...
//		{
//			LOGGER.error("Very weird URI parsing problem: " + e.toString(), e);
//		}
//	}
//	
...
//			{
//				LOGGER.info(baseUri + " already tested by ErrorXSS");
//				return;
//			}
...
//				else
//				{
//					LOGGER.debug("Error XSS can't request " + uri);
//				}
//			}
...
//			else
//			{
//				LOGGER.debug("ErrorXSS can't request " + uri);
//			}
//		}
//		catch (UnrequestableTransaction e)
//		{
...
//		catch (URISyntaxException e)
//		{
//			LOGGER.error("Very weird problem with URI parsing: " + e.toString(), e);
//		}
//	}
//
//}
