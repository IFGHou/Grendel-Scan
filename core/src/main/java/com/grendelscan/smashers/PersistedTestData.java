...
{
    private static final Logger LOGGER = LoggerFactory.getLogger(PersistedTestData.class);
	...
	public void initializeDatabase()
	{
		...
		{
			LOGGER.error("Problem with creating database for persisted test data: " + e.toString(), e);
			System.exit(1);
		}
	}
	...
	private void deleteItem(String name, String table)
	{
		...
		{
			LOGGER.error("Problem deleting from " + table + ": " + e.toString(), e);
		}
	}
