 ...
 * <p>
 * Rather than relying on the Flash Player team to change the AMF specification, Flex 1.5 introduced the concept of a Message Envelope that allowed them to provide message level headers that apply to
 * a single request body.
 * </p>
 * <p>
 * Essentially they introduced one more layer of indirection with an ASObject of type &quot;Envelope&quot; that had two properties:<br />
 ...
 * </p>
 * <p>
 * To save space on the wire, a Header structure was simply an array. The first element was the header name as a String, and was the only required field. The second element, a boolean, indicated
 * whether the header must be understood. The third element, any Object, represented the header value, if required.
 * </p>
 * 
