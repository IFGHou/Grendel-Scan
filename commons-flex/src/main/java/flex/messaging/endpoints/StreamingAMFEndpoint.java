...
/**
 * Extension to the AMFEndpoint to support streaming HTTP connections to connected clients. Each streaming connection managed by this endpoint consumes one of the request handler threads provided by
 ...
 * support polling clients and will fault any poll requests that are received. To support polling clients use AMFEndpoint instead.
 */
public class StreamingAMFEndpoint extends BaseStreamingHTTPEndpoint
{
     ...
     *            <code>true</code> if the <code>StreamingAMFEndpoint</code> is manageable; otherwise <code>false</code>.
     */
    ...
    /**
     * Used internally for performance information gathering; not intended for public use. Serializes the message in AMF format and returns the size of the serialized message.
     * 
     * @param message
    ...
    /**
     * Invoked automatically to allow the <code>StreamingAMFEndpoint</code> to setup its corresponding MBean control.
     * 
     * @param broker
     *            The <code>MessageBroker</code> that manages this <code>StreamingAMFEndpoint</code>.
     */
    @Override
    ...
    /**
     * Determines and returns the correct Amf3Output implementation for the JVM is use.
     * 
