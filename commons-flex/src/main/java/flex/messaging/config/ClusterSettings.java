...
public class ClusterSettings
{
     ...
     * 
     * @param def
     *            <code>true</code> is the cluster is default; otherwise <code>false</code>.
     */
     ...
     * 
     * @param propsFileName
     *            The properties file of the cluster.
     */
     ...
     * 
     * @param ulb
     *            <code>true</code> if the url load balancing is enabled; otherwise <code>false</code>.
     */
    ...
    /**
     * Sets the name of the cluster implementation class. The default is 'flex.messaging.cluster.JGroupsCluster'.
     * 
     * @param className
     * @exclude
     */
    ...
    /**
     * Get the name of the cluster implementation class. The class must support the flex.messaging.cluster.Cluster interface.
     * 
