...
/**
 * The server throws this exception type on encountering errors while parsing the configuration. Other classes may also throw this exception type during initialization in the event that the
 * configuration settings used to initialize the component was invalid.
 * 
