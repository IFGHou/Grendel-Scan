...
public class SystemSettings
{
    ...
    /*
     * TODO UCdetector: Remove unused code: public void addWatchFile(String watch) { this.watches.add(watch); }
     */
    ...
    /*
     * TODO UCdetector: Remove unused code: public void addTouchFile(String touch) { this.touches.add(touch); }
     */
