...
public class NetworkSettings
{
    ...
    /**
     * Constructs a default <code>NetworkSettings</code> instance with default session timeout.
     */
    ...
    /**
     * Sets the <code>subscription-timeout-minutes</code> property which is the idle time in minutes before a subscriber that no messages are being pushed to will be unsubscribed. A value of 0 will
     * cause subscriptions to be kept alive as long as the associated FlexSession they are created over is active.
     * 
     * @param value
     *            The value to set the <code>subscription-timeout-minutes</code> property to.
     */
     ...
     * 
     * @param sharedBackend
     *            The value to set the <code>shared-backend</code> property to.
     */
     ...
     * 
     * @param value
     *            The value to set the <code>ThrottleSettings</code> property to.
     */
