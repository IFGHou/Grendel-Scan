...
public class SecurityConstraint
{
     ...
     * 
     * @param id
     *            The id of the <code>SecurityConstraint</code> instance.
     */
    ...
    /**
     * Sets the authorization method of the <code>SecurityConstraint</code>. Valid values are Basic and Custom.
     * 
     * @param method
     *            The authentication method to set which can be custom or basic.
     */
