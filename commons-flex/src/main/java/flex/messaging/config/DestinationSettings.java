...
/**
 * Destinations are configured for a particular <code>Service</code>. A destination's configuration includes an <code>id</code> attribute to provide a public name for clients to use when sending
 * messages.
 * <p>
 * The configuration also specifies which channels are valid to contact the destination, as well as which adapter a service must use to process client messages for this destination and any security
...
public class DestinationSettings extends PropertiesSettings
{
     ...
     * 
     * @param settings
     *            A List of <code>ChannelSettings</code>.
     */
     ...
     * 
     * @return a <code>java.util.List</code> of <code>ChannelSetting</code>s describing the channels that can be used to contact this destination.
     */
    ...
    /**
     * Gets the <code>SecurityConstraint</code> that will be applied to this destination, or <code>null</code> if no constraint has been registered.
     * 
    ...
    /**
     * Sets the security constraint to be applied to this destination. Security constraints restrict which clients can contact this destination. Use <code>null</code> to remove an existing constraint.
     * 
     * @param sc
     *            the <code>SecurityConstraint</code> to apply to this destination.
     */
     ...
     * 
     * @param a
     *            The <code>AdapterSettings</code> that describe the adapter to use for this destination.
     */
     ...
     * 
     * @return <code>AdapterSettings</code> for this destinations adapter. A <code>null</code> value implies the the default service adapter should be used.
     */
