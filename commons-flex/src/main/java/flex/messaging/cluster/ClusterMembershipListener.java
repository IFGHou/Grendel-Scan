...
/**
 * @exclude Clusters employ this Listener in order to respond to nodes which join and abandon it. This class bridges the low-level protocol layer to the more abstract logical cluster.
 * 
 * @author neville
 */
class ClusterMembershipListener implements MembershipListener
{
    ...
    /**
     * This method is invoked by the cluster infrastructure whenever a member joins or abandons the cluster group.
     */
    @Override
    ...
    /**
     * This method is invoked by the cluster infrastructure whenever a member appears to have left the cluster, but before it has been removed from the active member list. The Cluster treats these
     * addresses as zombies and will not use their channel and endpoint information.
     */
    @Override
    ...
    /**
     * This method from the core MembershipListener is a no-op for the Flex destination Cluster.
     */
    @Override
    public void block()
    {
    ...
    /**
     * Allow the Cluster to determine whether a given physical address is a zombie.
     */
