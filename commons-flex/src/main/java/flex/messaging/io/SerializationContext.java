...
public class SerializationContext implements Serializable, Cloneable
{
    ...
    /**
     * Provides a way to control whether small messages should be sent even if the client can support them. If set to false, small messages will not be sent.
     * 
     * The default is true.
     */
    ...
    /**
     * Determines whether type information will be used to instantiate a new instance. If set to false, types will be deserialized as flex.messaging.io.ASObject instances with type information
     * retained but not used to create an instance.
     * 
     * Note that types in the flex.* package (and any subpackage) will always be instantiated.
     * 
     * The default is true.
     */
     ...
     * 
     * @param context
     *            The current SerializationContext.
     */
