...
{
    /**
     * 3-byte marker for object end; used for faster serialization than a combination of writeUTF("") and writeByte(kObjectEndType).
     * 
     * @exclude
     */
     ...
     * 
     * @param a
     *            Whether the client is running in AVMPlus and can handle AMF3 encoding.
     */
     ...
     * 
     * @param c
     *            Collection to be serialized as an array.
     * @throws java.io.IOException
     *             The exception can be generated by the output stream
     * @exclude
     */
    ...
    /**
     * Remember the object's serialization number so that it can be referred to as a reference later. Only complex ojects should be stored as references.
     * 
     * @exclude
     */
    ...
    /**
     * protected void writeUnsupported() throws IOException { if (isDebug) trace.write("UNSUPPORTED");
     * 
