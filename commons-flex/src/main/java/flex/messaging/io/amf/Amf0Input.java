...
{
    /**
     * Unfortunately the Flash Player starts AMF 3 messages off with the legacy AMF 0 format and uses a type, AmfTypes.kAvmPlusObjectType, to indicate that the next object in the stream is to be
     * deserialized differently. The original hope was for two independent encoding versions... but for now we just keep a reference to objectInput here.
     * 
     * @exclude
     */
    ...
    protected Date readDate() throws IOException
    {
        ...
        /*
         * We read in the timezone but do nothing with the value as we expect dates to be written in the UTC timezone. Client and servers are responsible for applying their own timezones.
         */
        in.readShort();
    ...
    /**
     * This code borrows heavily from DataInputStreat.readUTF(). However, it uses a 32-bit string length.
     * 
     * @return the read String
     * @throws java.io.UTFDataFormatException
     *             if the UTF-8 encoding is incorrect
     * @throws IOException
