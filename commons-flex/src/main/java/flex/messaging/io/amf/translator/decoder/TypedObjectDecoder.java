...
/**
 * Decodes an ASObject to a Java object based on the type information returned from the ASObject.getType().
 * 
 * If the TranslationContext has been set up to support _remoteClass then this property may be used as a back up.
 * 
 * @exclude
 */
