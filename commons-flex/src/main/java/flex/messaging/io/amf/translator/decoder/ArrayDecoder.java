...
/**
 * Decodes native Java Array, java.util.Collection, or java.lang.String (to char[]) instances to a native Java Array instance with desired component type.
 * 
 * This class does not handle the case where the source encodedObject is modified while decoding.
 * 
 * @author Brian Deitte
