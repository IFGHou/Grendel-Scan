...
public class ActionScriptAdapter extends MessagingAdapter
{
    ...
    /**
     * Invoked automatically to allow the <code>ActionScriptAdapter</code> to setup its corresponding MBean control.
     * 
     * @param broker
     *            The <code>Destination</code> that manages this <code>ActionScriptAdapter</code>.
     */
    @Override
