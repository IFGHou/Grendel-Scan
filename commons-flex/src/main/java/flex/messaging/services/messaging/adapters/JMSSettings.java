...
public class JMSSettings
{
    ...
    /**
     * Creates a <code>JMSSettings</code> instance with the following default values: acknowledge mode of AUTO_ACKNOWLEDGE, delivery mode of DEFAULT_DELIVERY_MODE, destination type of Topic, and
    ...
    /**
     * Sets the <code>acknowledge-mode</code> property which is the message acknowledgement mode for the JMS adapter. None of these modes require any action on the part of the Flex messaging client.
     * This property is optional and defautls to AUTO_ACKNOWLEDGE.
     * 
     * @param mode
     *            Message acknowledgement mode. Supported modes are: AUTO_ACKNOWLEDGE - the JMS provider client runtime automatically acknowledges the messages. DUPS_OK_ACKNOWLEDGE -
     *            auto-acknowledgement of the messages is not required. CLIENT_ACKNOWLEDGE - the JMS adapter should acknowledge that the message was received.
     * 
     */
    public void setAcknowledgeMode(String mode)
    {
        ...
        if (!(mode.equals(JMSConfigConstants.AUTO_ACKNOWLEDGE) || mode.equals(JMSConfigConstants.DUPS_OK_ACKNOWLEDGE) || mode.equals(JMSConfigConstants.CLIENT_ACKNOWLEDGE)))
        {
    ...
    /**
     * Sets the <code>connection-factory</code> property which is the name of the JMS connection factory in JNDI. This property is required and it cannot be null.
     * 
     * @param factory
     *            The non-null name of the JMS connection factory.
     */
    ...
    /**
     * Sets the <code>delivery-mode</code> property which is the JMS DeliveryMode for producers. This property optional and defaults to DEFAULT_DELIVERY_MODE.
     * 
     * @param mode
     *            The delivery mode. Valid values are DEFAULT_DELIVERY_MODE, PERSISTENT, and NON_PERSISTENT.
     */
    public void setDeliveryMode(String mode)
    {
        ...
        if (!(mode.equals(JMSConfigConstants.DEFAULT_DELIVERY_MODE) || mode.equals(JMSConfigConstants.PERSISTENT) || mode.equals(JMSConfigConstants.NON_PERSISTENT)))
        {
    ...
    /**
     * Sets the <code>delivery-settings</code> property. This property is optional and defaults to default settings as described in <code>DeliverySettings</code> inner class.
     * 
     * @param deliverySettings
     *            The <code>delivery-settings</code> property.
     */
    ...
    /**
     * Sets the <code>destination-jndi-name</code> property which is the name of the destination in JNDI. This value is required and it cannot be null.
     * 
     * @param name
     *            The non-null name of the destination in JNDI.
     */
    ...
    /**
     * Sets the <code>destination-type</code> property which determines whether the adapter is performing topic (pub/sub) or queue (point-to-point) messaging. This element is optional and defaults to
     * Topic.
     * 
     * @param type
     *            The destination type. Valid values are Topic and Queue.
     */
     ...
     * 
     * @return <code>true</code> is consumers are durable, <code>false</code> otherwise.
     */
     ...
     * 
     * @param durable
     *            A boolean indicating whether consumers should be durable.
     */
    ...
    /**
     * Sets the <code>initial-context-environment</code> property. This property is optional.
     * 
     * @param env
     *            A Hashtable of the <code>initial-context-environment</code>.
     */
    ...
    /**
     * Sets the <code>max-producers</code> property which is the maximum number of producer proxies that this destination should use when communicating with the JMS Server. This property is optional
     * and defaults to 1 which implies all clients using this destinatin will share the same connection to the JMS server.
     * 
     * @param value
     *            an int representing the <code>max-producers</code>.
     */
    ...
    /**
     * Sets the <code>message-priority</code> property which is the JMS priority for messages sent by Flex producers. This property is optional and defaults to
     * <code>javax.jms.Message.DEFAULT_PRIORITY</code>.
     * 
     * @param priority
     *            an int specifying the <code>message-priority</code>.
     */
    ...
    /**
     * Sets the <code>message-type</code> property which is the <code>javax.jms.Message</code> type which the adapter should use for the destination.
     * 
     * @param type
     *            The <code>message-type</code> property. Supported types are <code>javax.jms.TextMessage</code>, <code>javax.jms.ObjectMessage</code>.
     */
    public void setMessageType(String type)
    {
        if (type == null || (!(type.equals(JMSConfigConstants.TEXT_MESSAGE) || type.equals(JMSConfigConstants.OBJECT_MESSAGE))))
        {
    ...
    /**
     * Sets the <code>preserve-jms-headers</code> property. This property is optional and defaults to true.
     * 
     * @param preserveJMSHeaders
     *            The <code>preserve-jms-headers</code> property.
     */
     ...
     * @deprecated
     * @param mode
     *            The transacted-session property.
     */
    ...
    public static class DeliverySettings
    {
        ...
        /**
         * Creates a default <code>DeliverySettings</code> instance with default settings.
         */
         ...
         * 
         * @param mode
         *            The message delivery mode. Valid values are async and sync.
         */
         ...
         * 
         * @param syncReceiveIntervalMillis
         *            A positive long that indicates the interval of the receive message call.
         */
         ...
         * 
         * @param syncReceiveWaitMillis
         *            A non-negative value that indicates how long a JMS proxy waits for a message before returning. Zero means no wait, negative one means wait until a message arrives.
         */
