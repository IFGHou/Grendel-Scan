...
/**
 * Represents a message destination subtopic. You are given instances of Subtopics as arguments to the MessagingAdapter.allowSubscribe and allowSend methods. These are used to implement your own
 * authorization for the subscribe and send messages to specific subtopics.
 */
public class Subtopic
{
     ...
     * 
     * @param subtopic
     *            The full subtopic string.
     * @param separator
     *            The separator for tokenizing a hierarchical subtopic.
     */
    public Subtopic(String subtopic, String separator)
    {
        ...
        else if ((separator != null) && (subtopic.indexOf(separator) != -1))
        {
            hierarchical = true;
            /*
             * Each token must have non-zero length, meaning no leading or trailing separator or empty subtopics in between.
             */
            ...
            /*
             * If a token contains the SUBTOPIC_WILDCARD, that token may not contain any additional characters. I.e. chat.* is OK, chat.f* is not OK (assuming a separator of '.').
             */
     ...
     * 
     * @return true if the subtopic contains a hierarchical subtopic wildcard, otherwise false.
     */
    ...
    /**
     * Returns the separator used to create this Subtopic instance. This value may be <code>null</code>.
     * 
    ...
    /**
     * Matches the passed subtopic against this subtopic. If neither subtopic contains a wildcard they must literally match. If one or the other contains a wildcard they may match. "chatrooms.*" will
     * match "chatrooms.lobby" or "chatrooms.us.ca" but will not match "chatrooms" (assuming a subtopic separator of "."). "chatrooms.*.ca" will match "chatrooms.us.ca" but not "chatrooms.us.ma".
     * 
     * @param other
     *            The other subtopic to match against this subtopic.
