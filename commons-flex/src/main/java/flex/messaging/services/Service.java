...
public interface Service extends Manageable, FlexComponent
{
    ...
    /**
     * Unregistered the adapter with the <code>Service</code> and set the default adapter to <code>null</code> if needed.
     * 
     * @param id
     *            The id of the adapter.
     ...
     * 
     * @param id
     *            The id of the default adapter of the <code>Service</code>.
     */
    ...
    /**
     * Adds the channel to the list of channels of the <code>Service</code>. <code>MessageBroker</code> has to know the channel. Otherwise, the channel should not added to the list.
     * 
     * @param id
    ...
    /**
     * Sets the channel list of the <code>Service</code>. <code>MessageBroker</code> has to know the channels, otherwise they should not be added to the list.
     * 
     * @param ids
     *            List of channel ids.
     */
    ...
    /**
     * Creates a <code>Destination</code> instance, sets its id, sets it manageable if the <code>Service</code> that created it is manageable, and sets its <code>Service</code> to the
     * <code>Service</code> that created it.
     * 
     * @param id
     *            The id of the <code>Destination</code>.
     ...
     * 
     * @param destination
     *            The <code>Destination</code> to be added.
     */
    ...
    /**
     * All services must be managed by a single MessageBroker, and must be capable of returning a reference to that broker. This broker is used when a service wishes to push a message to one or more
     * endpoints managed by the broker.
     * 
     ...
     * 
     * @param broker
     *            The <code>MessageBroker</code> of the <code>Service</code>.
     */
     ...
     * 
     * @param endpoint
     *            Endpoint used to filter the service destinations.
     ...
     * 
     * @param message
     *            The message sent by the MessageBroker.
