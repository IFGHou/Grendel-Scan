...
/**
 * The LocalizedException class is the base class for server exceptions that use localized error message and details strings. This class overloads <code>setMessage</code> and <code>setDetails</code>
 * to support passing an error number and an optional message variant that is used to look up a localized error message or details string using a <code>ResourceLoader</code>. These methods also set
 * the number property of the exception instance.
 * <p>
...
public class LocalizedException extends RuntimeException
{
     ...
     * 
     * @param number
     *            The error number for this exception instance.
     */
     ...
     *            The error number for this exception instance.
     * @param arguments
     *            The arguments to substitute into the error message.
     */
     ...
     *            The error number for this exception instance.
     * @param variant
     *            The varient of the error message for this instance.
     * @param arguments
     *            The arguments to substitute into the error message.
     */
     ...
     *            The error number for this exception instance.
     * @param variant
     *            The variant of the error message for this instance.
     * @param locale
     *            The target locale for error message lookup.
     * @param arguments
     *            The arguments to substitute into the error message.
     */
     ...
     * 
     * @param number
     *            The error number to lookup details for.
     */
     ...
     *            The error number to lookup details for.
     * @param variant
     *            The variant of the details string to lookup.
     */
     ...
     *            The variant of the details string to lookup.
     * @param arguments
     *            The arguments to substitute into the details string.
     */
     ...
     * 
     * @param number
     *            The error number to lookup a localized details string for.
     * @param variant
     *            The variant of the details string to lookup.
     * @param locale
     *            The target locale for the lookup.
     * @param arguments
     *            The arguments to substitute into the details string.
     */
    ...
    /**
     * Generates the full key to lookup a localized error message based on an error number and an optional variant followed by a "-details" suffix. If the variant is null, the lookup key is the error
     * number.
     * 
     * @param number
     *            The error number.
     * @param variant
     *            The variant of the error message.
    ...
    /**
     * Generates the full key to lookup a localized details string based on an error number and an optional variant followed by a "-details" suffix. If the variant is null, the lookup key is the error
     * number followed by a "-details" suffix.
     * 
     * @param number
     *            The error number.
     * @param variant
     *            The variant of the details message.
