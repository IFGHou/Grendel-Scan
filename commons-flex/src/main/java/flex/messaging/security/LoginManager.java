...
public class LoginManager implements FlexComponent
{
     ...
     * @param configMap
     *            The properties for configuring component.
     */
    @Override
    ...
    /**
     * Implements FlexComponent.start. Starts the <code>LoginManager</code>.
     */
    @Override
    public void start()
    {
    ...
    /**
     * Implements FlexComponents.stop. Stops the <code>LoginManager</code>.
     */
    @Override
    public void stop()
    {
     ...
     * 
     * @return <code>true</code> if per client authentication is enabled; otherwise <code>false</code>.
     */
     ...
     * 
     * @param perClientAuthentication
     *            <code>true</code> if per client authentication is enabled; otherwise <code>false</code>.
     */
    ...
    /**
     * Throws various <code>SecurityException</code>s depending on whether an authenticated user is associated with the current session and if one is whether the passed constraint prohibits this user
     * from performing an operation. If a valid user is found and passed the constraint, no exceptions are thrown
     * 
     * @param constraint
     *            Constraint against which the current user is authorized.
     */
    ...
    /**
     * Returns true if the passed in principal belongs to at least one of the roles in the passed in list of roles.
     * 
     * @param principal
     *            Principal to check against roles
     * @param roles
     *            list of roles
