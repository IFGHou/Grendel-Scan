...
public class ExceptionUtil
{
    ...
    /**
     * Utility method for converting an exception and all chained root causes into a string. Unlike <code>exceptionToString(Throwable)</code> which prints the chain from most nested root cause down to
     * the top-level exception, this method prints from the top-level exception down to the most nested root cause.
     * 
     * @param t
     *            The throwable exception.
     * @return The printable exception.
