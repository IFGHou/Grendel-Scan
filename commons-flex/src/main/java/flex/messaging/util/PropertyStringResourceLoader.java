...
/**
 * Implementation of <code>ResourceLoader</code> that loads string resources from property files.
 * <p>
 * This class uses <code>MessageFormat</code> to perform substitutions within parameterized strings.
 * </p>
 * 
 * @author Seth Hodgson
 * @see MessageFormat
...
public class PropertyStringResourceLoader implements ResourceLoader
{
    ...
    /**
     * Constructs a <code>PropertyStringResourceLoader</code> using the default property bundles specified by the <code>PROPERTY_BUNDLE</code> and <code>LCDS_PROPERTY_BUNDLE</code> fields.
     */
    ...
    /**
     * Constructs a <code>PropertyStringResourceLoader</code> that will use the specified property bundle to use for string lookups.
     * 
     * @param propertyBundle
     *            The property bundles to use for lookups.
     */
    ...
    /**
     * Constructs a <code>PropertyStringResourceLoader</code> that will use the specified property bundles to use for string lookups.
     * 
     * @param propertyBundles
     *            The list of the property bundles to use for lookups.
     */
    ...
    public String getString(String key, Locale locale, Object[] arguments)
    {
        ...
        String localeKey = (locale != null) ? generateLocaleKey(locale) : generateLocaleKey(defaultLocale);
        String originalStringKey = generateStringKey(key, localeKey);
        int trimIndex = 0;

        /*
         * Attempt to get a string for the target locale - fail back to less specific versions of the locale.
         */
        while (true)
        {
        ...
        /*
         * Attempt to get the string in our default locale if it is different than the requested locale.
         */
     ...
     * 
     * @param localeKey
     *            The locale to load strings for.
     */
     ...
     * 
     * @param locale
     *            The locale to generate a cache key for.
     ...
     * 
     * @param key
     *            The string to generate a cache key for.
     * @param locale
     *            The locale to retrieve the string for.
     ...
     * 
     * @param parameterized
     *            The string containing parameter tokens for substitution.
     * @param arguments
