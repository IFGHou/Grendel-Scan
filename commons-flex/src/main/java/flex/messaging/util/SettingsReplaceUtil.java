...
/**
 * Methods for replacing tokens in config files {context.root}, {context-root}, {server.name}, {server-name}, {server.port}, {server-port}.
 * 
 * @exclude
 */
public class SettingsReplaceUtil
{
    ...
    /**
     * replace {server.name} a horribly complicated way. This is needed to support relative URLs. I would like for us to rethink this someday and find a better way to do this
     */
