...
public class RedeployManager implements FlexComponent
{
    ...
    /**
     * Constructs a new <code>RedeployManager</code> with the supplied thread factory.
     * 
     * @param tf
     *            Thread factory to use for the scheduled service used.
     */
    ...
    /**
     * Implements FlexComponents.initialize. This is no-op for RedeployManager as it does not have an id and all its properties are directly settable.
     */
    @Override
    ...
    /**
     * Implements FlexComponent.start. Starts the <code>RedeployManager</code>.
     */
    @Override
    public void start()
    {
     ...
     * 
     * @param enabled
     *            Whether redeploy is enabled or not.
     */
    ...
    /**
     * Implements FlexComponent.isStarted. Returns whether the RedeployManager is started or not.
     * 
    ...
    /**
     * Adds a watch file. Note that the watch file set with this method should not contain the context.root token.
     * 
     * @param watch
     *            The watch file to add.
     */
    ...
    /**
     * Sets the list of watch files. Note that watch files set with this method should not contain contain the context.root token.
     * 
     * @param watches
     *            The list of watch files to set.
     */
    ...
    /**
     * Adds a touch file. Note that the touch file set with this method should not contain the context.root token.
     * 
     * @param touch
     *            The touch file to add.
     */
    ...
    /**
     * Sets the list of touch files. Note that touch files set with this method should not contain the context.root token.
     * 
     * @param touches
     *            The list of touch files to set.
     */
