...
public class MBeanServerLocatorFactory
{
     ...
     *            The classname of the desired MBeanServerLocator.
     * @param dependencyClassNames
     *            Any additional dependent classnames that the desired locator depends upon that should also be tested for availability.
     */
    ...
    /**
     * Direct instantiation is not allowed. Use <code>getMBeanServerLocator()</code> to obtain a <code>MBeanServerLocator</code> instance to lookup the proper MBean server to use.
     */
