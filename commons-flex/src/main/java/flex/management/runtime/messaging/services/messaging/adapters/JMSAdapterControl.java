...
/**
 * The <code>JMSAdapterControl</code> class is the MBean implemenation for monitoring and managing <code>JMSAdapter</code>s at runtime.
 * 
 * @author shodgson
 */
public class JMSAdapterControl extends ServiceAdapterControl implements JMSAdapterControlMBean
{
    ...
    /**
     * Constructs a <code>JMSAdapterControl</code>, assigning its id, managed <code>JMSAdapter</code> and parent MBean.
     * 
     * @param serviceAdapter
     *            The <code>JMSAdapter</code> managed by this MBean.
     * @param parent
