...
/**
 * The <code>JavaAdapterControl</code> class is the MBean implemenation for monitoring and managing Java service adapters at runtime.
 * 
 * @author shodgson
 */
public class JavaAdapterControl extends ServiceAdapterControl implements JavaAdapterControlMBean
{
    ...
    /**
     * Constructs a <code>JavaAdapterControl</code>, assigning its id, managed Java service adapter and parent MBean.
     * 
     * @param serviceAdapter
     *            The <code>JavaAdapter</code> managed by this MBean.
     * @param parent
