...
/**
 * The <code>EndpointControl</code> class is the MBean implementation for monitoring and managing an <code>Endpoint</code> at runtime.
 * 
 * @author shodgson
 */
public abstract class EndpointControl extends BaseControl implements EndpointControlMBean
{
    ...
    /**
     * Constructs an <code>EndpointControl</code>, assigning its managed endpoint and parent MBean.
     * 
     * @param endpoint
     *            The <code>Endpoint</code> managed by this MBean.
     * @param parent
    ...
    protected void onRegistrationComplete()
    {
        ...
        getRegistrar().registerObjects(AdminConsoleTypes.ENDPOINT_SCALAR, name, generalNames);
        getRegistrar().registerObjects(AdminConsoleTypes.ENDPOINT_POLLABLE, name, generalPollables);
        getRegistrar().registerObjects(new int[] { AdminConsoleTypes.GRAPH_BY_POLL_INTERVAL, AdminConsoleTypes.ENDPOINT_POLLABLE }, name, pollableGraphByInterval);
    }
