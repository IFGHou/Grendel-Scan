...
/**
 * The <code>ServiceControl</code> class is the MBean implementation for monitoring and managing a <code>Service</code> at runtime.
 * 
 * @author shodgson
 */
public abstract class ServiceControl extends BaseControl implements ServiceControlMBean
{
    ...
    /**
     * Constructs a <code>ServiceControl</code>, assigning its id, managed service and parent MBean.
     * 
     * @param service
     *            The <code>Service</code> managed by this MBean.
     * @param parent
     ...
     * 
     * @param value
     *            The <code>ObjectName</code> of a destination registered with the managed service.
     */
