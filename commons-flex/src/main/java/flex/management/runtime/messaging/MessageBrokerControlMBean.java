...
public interface MessageBrokerControlMBean extends BaseControlMBean
{
    ...
    /**
     * Returns the <code>ObjectName</code>s for endpoints that are registered with the managed <code>MessageBroker</code>.
     * 
    ...
    /**
     * Returns the <code>ObjectName</code>s for services that are registered with the managed <code>MessageBroker</code>.
     * 
    ...
    /**
     * Returns the maximum concurrent Flex session count for the <code>MessageBroker</code> in the current hour.
     * 
     * @return The maximum concurrent Flex session count for the <code>MessageBroker</code> in the last hour.
     * @throws IOException
     *             Throws IOException.
     */
