...
/**
 * The <code>ServiceAdapterControl</code> class is the base MBean implementation for monitoring and managing a <code>ServiceAdapter</code> at runtime.
 * 
 * @author shodgson
 */
public abstract class ServiceAdapterControl extends BaseControl implements ServiceAdapterControlMBean
{
    ...
    /**
     * Constructs a <code>ServiceAdapterControl</code>, assigning its id, managed service adapter and parent MBean.
     * 
     * @param serviceAdapter
     *            The <code>ServiceAdapter</code> managed by this MBean.
     * @param parent
