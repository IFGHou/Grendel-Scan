...
public interface ServiceControlMBean extends BaseControlMBean
{
    ...
    /**
     * Returns the <code>ObjectName</code>s of all destinations registered with the managed service.
     * 
     * @return The <code>ObjectName</code>s of all destinations registered with the managed service.
     * @throws IOException
     *             Throws IOException.
     */
