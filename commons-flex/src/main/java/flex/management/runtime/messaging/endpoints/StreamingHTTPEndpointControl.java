...
/**
 * The <code>StreamingHTTPEndpointControl</code> class is the MBean implemenation for monitoring and managing a <code>StreamingHTTPEndpoint</code> at runtime.
 */
public class StreamingHTTPEndpointControl extends StreamingEndpointControl implements StreamingHTTPEndpointControlMBean
{
    ...
    /**
     * Constructs a <code>StreamingHTTPEndpointControl</code>, assigning managed message endpoint and parent MBean.
     * 
     * @param endpoint
     *            The <code>StreamingHTTPEndpoint</code> managed by this MBean.
     * @param parent
