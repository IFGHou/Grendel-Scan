...
/**
 * The <code>RemotingServiceControl</code> class is the MBean implemenation for monitoring and managing a <code>RemotingService</code> at runtime.
 * 
 * @author shodgson
 */
public class RemotingServiceControl extends ServiceControl implements RemotingServiceControlMBean
{
    ...
    /**
     * Constructs a <code>RemotingServiceControl</code>, assigning its id, managed remoting service and parent MBean.
     * 
     * @param service
     *            The <code>RemotingService</code> managed by this MBean.
     * @param parent
