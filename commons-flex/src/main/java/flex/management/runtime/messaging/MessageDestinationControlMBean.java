...
/**
 * Defines the runtime monitoring and management interface for managed <code>MessageDestination</code>s.
 * 
 * @author shodgson
 */
...
{
    /**
     * Returns the <code>ObjectName</code> for the message cache used by the managed destination.
     * 
    ...
    /**
     * Returns the <code>ObjectName</code> for the throttle manager used by the managed destination.
     * 
    ...
    /**
     * Returns the <code>ObjectName</code> for the subscription manager used by the managed destination.
     * 
     ...
     * 
     * @return The number of messages from an adapter that the managed service has processed
     * @throws IOException
     *             Throws IOException.
     */
