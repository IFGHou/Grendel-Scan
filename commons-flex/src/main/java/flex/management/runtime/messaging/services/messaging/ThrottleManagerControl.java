...
/**
 * The <code>ThrottleManagerControl</code> class is the MBean implementation for monitoring and managing a <code>ThrottleManager</code> at runtime.
 * 
 * @author shodgson
 */
public class ThrottleManagerControl extends BaseControl implements ThrottleManagerControlMBean
{
    ...
    /**
     * Constructs a new <code>ThrottleManagerControl</code> instance, assigning its backing <code>ThrottleManager</code>.
     * 
     * @param throttleManager
     *            The <code>ThrottleManager</code> managed by this MBean.
     * @param parent
    ...
    protected void onRegistrationComplete()
    {
        ...
        String[] attributes = { "ClientIncomingMessageThrottleCount", "ClientIncomingMessageThrottleFrequency", "ClientOutgoingMessageThrottleCount", "ClientOutgoingMessageThrottleFrequency", "DestinationIncomingMessageThrottleCount",
                        "DestinationIncomingMessageThrottleFrequency", "DestinationOutgoingMessageThrottleCount", "DestinationOutgoingMessageThrottleFrequency", "LastClientIncomingMessageThrottleTimestamp", "LastClientOutgoingMessageThrottleTimestamp",
