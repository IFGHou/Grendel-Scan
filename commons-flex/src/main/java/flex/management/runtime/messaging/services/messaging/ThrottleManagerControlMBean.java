...
/**
 * Defines the runtime monitoring and management interface for <code>ThrottleManager</code>s.
 * 
 * @author shodgson
 */
public interface ThrottleManagerControlMBean extends BaseControlMBean
{
     ...
     * 
     * @return The number of incoming client messages that have been throttled.
     * @throws IOException
     *             Throws IOException.
     */
     ...
     * 
     * @return The timestamp when an incoming client message was most recently throttled.
     * @throws IOException
     *             Throws IOException.
     */
     ...
     * 
     * @return The number of incoming client messages that have been throttled per minute.
     * @throws IOException
     *             Throws IOException.
     */
     ...
     * 
     * @return The number of outgoing client messages that have been throttled.
     * @throws IOException
     *             Throws IOException.
     */
     ...
     * 
     * @return The timestamp when an outgoing client message was most recently throttled.
     * @throws IOException
     *             Throws IOException.
     */
     ...
     * 
     * @return The number of outgoing client messages that have been throttled per minute.
     * @throws IOException
     *             Throws IOException.
     */
     ...
     * 
     * @return The number of incoming destination messages that have been throttled.
     * @throws IOException
     *             Throws IOException.
     */
     ...
     * 
     * @return The timestamp when an incoming destination message was most recently throttled.
     * @throws IOException
     *             Throws IOException.
     */
     ...
     * 
     * @return The number of incoming destination messages that have been throttled per minute.
     * @throws IOException
     *             Throws IOException.
     */
     ...
     * 
     * @return The number of outgoing destination messages that have been throttled.
     * @throws IOException
     *             Throws IOException.
     */
     ...
     * 
     * @return The timestamp when an outgoing destination message was most recently throttled.
     * @throws IOException
     *             Throws IOException.
     */
     ...
     * 
     * @return The number of outgoing destination messages that have been throttled per minute.
     * @throws IOException
     *             Throws IOException.
     */
