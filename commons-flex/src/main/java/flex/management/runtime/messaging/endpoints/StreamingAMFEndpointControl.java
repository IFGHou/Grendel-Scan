...
/**
 * The <code>StreamingAMFEndpointControl</code> class is the MBean implemenation for monitoring and managing an <code>StreamingAMFEndpoint</code> at runtime.
 */
public class StreamingAMFEndpointControl extends StreamingEndpointControl implements StreamingAMFEndpointControlMBean
{
    ...
    /**
     * Constructs a <code>StreamingAMFEndpointControl</code>, assigning managed message endpoint and parent MBean.
     * 
     * @param endpoint
     *            The <code>StreamingAMFEndpoint</code> managed by this MBean.
     * @param parent
