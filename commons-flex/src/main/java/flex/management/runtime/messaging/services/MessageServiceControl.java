...
/**
 * The <code>MessageServiceControl</code> class is the MBean implemenation for monitoring and managing a <code>MessageService</code> at runtime.
 * 
 * @author shodgson
 */
public class MessageServiceControl extends ServiceControl implements MessageServiceControlMBean
{
    ...
    /**
     * Constructs a <code>MessageServiceControl</code>, assigning its id, managed message service and parent MBean.
     * 
     * @param service
     *            The <code>MessageService</code> managed by this MBean.
     * @param parent
