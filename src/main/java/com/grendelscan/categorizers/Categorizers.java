...
import com.grendelscan.categorizers.impl.ByRequestDataCategorizer;
...
public class Categorizers
{
	...
	final private ByRequestDataCategorizer byHttpQueryParameterCategorizer; 
	...
	public Categorizers()
	{
		...
		byHttpQueryParameterCategorizer = new ByRequestDataCategorizer();
...
//		allCategorizers.add(byAuthenticationPackageCategorizerCategorizer);
	...
	public ByRequestDataCategorizer getByHttpQueryParameterCategorizer()
    {
