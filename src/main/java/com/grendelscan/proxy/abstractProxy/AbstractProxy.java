...
public abstract class AbstractProxy
{
	...
	protected synchronized void initParams()
	{
		if (!initialized)
		{
			...
			HttpParams clientParams = ClientUtilities.createHttpParams(10, 5); // need to put these in a config file
			HttpContext clientContext = ClientUtilities.createHttpContext();
			
			ccm = ClientUtilities.createClientConnectionManager(clientParams);
