...
//	protected AddRemoveListComposite	ignoredParameterList;
	...
	public ScanRestrictionsSettingsComposite(org.eclipse.swt.widgets.Composite parent, int style)
	{
		super(parent, style);
		initGUI();
	}
