 ...
 */
public class SessionHandlingComposite extends org.eclipse.swt.widgets.Composite implements
		GrendelSettingsControl
{
	...
	public SessionHandlingComposite(org.eclipse.swt.widgets.Composite parent, int style)
	{
		super(parent, style);
		initGUI();
	}
