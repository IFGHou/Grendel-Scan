 ...
 */
public class TransactionTableSettingsDialog extends org.eclipse.swt.widgets.Dialog
{

	private Button					allSourceButton;
	private Button					authenticationSourceCheckbox;
	private Button					baseUrlCheckbox;
	private Button					cancelButton;
	private Button					categorizerSourceCheckbox;
	private boolean					changed;
	private Button					cobraSourceCheckbox;
	private Shell					dialogShell;
	private Button					enumerationSourceCheckbox;
	private TransactionTableFilter	existingSettings;
	private Group					filterGroup;
	private Button					fuzzerSourceCheckbox;
	private Label					hostRegexLabel;
	private Text					hostRegexText;
	private Button					manualRequestCheckbox;
	private Button					niktoSourceCheckbox;
	private Button					noneSourceButton;
	private Button					okButton;
	private Button					overrideSourceCheckbox;
	private Label					pathRegexLabel;
	private Text					pathRegexText;
	private Button					proxySourceCheckbox;
	private Label					queryRegexLabel;
	private Text					queryRegexText;
	private Button					resetButton;
	private Label					responseCodeRegexLabel;
	private Text					responseCodeRegexText;
	private Button					spiderSourceCheckbox;
	private Button					testSourceCheckbox;
	private Group					transactionSourceGroup;

	public TransactionTableSettingsDialog(Shell parent, int style)
	{
		super(parent, style);
	}
	...
	public boolean open(TransactionTableFilter existingSettings)
	{
		...
		dialogShell.setText(GrendelScan.versionText + " - Transaction Table Settings");
	...
	private void createDialog()
	{
		...
		{
			resetButton = new Button(dialogShell, SWT.PUSH | SWT.CENTER);
		...
		{
			filterGroup = new Group(dialogShell, SWT.NONE);
			...
			{
				hostRegexLabel = new Label(filterGroup, SWT.NONE);
			...
			}
			{
				...
				hostRegexText = new Text(filterGroup, SWT.BORDER);
				hostRegexText.setLayoutData(hostRegexTextLData);
			}
			{
				pathRegexLabel = new Label(filterGroup, SWT.NONE);
			...
			}
			{
				...
				pathRegexText = new Text(filterGroup, SWT.BORDER);
				pathRegexText.setLayoutData(pathRegexTextLData);
			}
			{
				queryRegexLabel = new Label(filterGroup, SWT.NONE);
			...
			}
			{
				...
				queryRegexText = new Text(filterGroup, SWT.BORDER);
				queryRegexText.setLayoutData(queryRegexTextLData);
			}
			{
				responseCodeRegexLabel = new Label(filterGroup, SWT.WRAP);
			...
			}
			{
				...
				responseCodeRegexText = new Text(filterGroup, SWT.BORDER);
				responseCodeRegexText.setLayoutData(responseCodeRegexTextLData);
			}
		}
		{
			transactionSourceGroup = new Group(dialogShell, SWT.NONE);
			...
			{
				fuzzerSourceCheckbox = new Button(transactionSourceGroup, SWT.CHECK | SWT.LEFT);
			...
			{
				allSourceButton = new Button(transactionSourceGroup, SWT.PUSH | SWT.CENTER);
			...
			{
				noneSourceButton = new Button(transactionSourceGroup, SWT.PUSH | SWT.CENTER);
			...
			{
				proxySourceCheckbox = new Button(transactionSourceGroup, SWT.CHECK | SWT.LEFT);
			...
			{
				manualRequestCheckbox = new Button(transactionSourceGroup, SWT.CHECK | SWT.LEFT);
			...
			{
				spiderSourceCheckbox = new Button(transactionSourceGroup, SWT.CHECK | SWT.LEFT);
			...
			{
				testSourceCheckbox = new Button(transactionSourceGroup, SWT.CHECK | SWT.LEFT);
			...
			{
				enumerationSourceCheckbox = new Button(transactionSourceGroup, SWT.CHECK | SWT.LEFT);
			...
			{
				baseUrlCheckbox = new Button(transactionSourceGroup, SWT.CHECK | SWT.LEFT);
			...
			{
				authenticationSourceCheckbox = new Button(transactionSourceGroup, SWT.CHECK | SWT.LEFT);
			...
			{
				niktoSourceCheckbox = new Button(transactionSourceGroup, SWT.CHECK | SWT.LEFT);
			...
			{
				categorizerSourceCheckbox = new Button(transactionSourceGroup, SWT.CHECK | SWT.LEFT);
			...
			{
				overrideSourceCheckbox = new Button(transactionSourceGroup, SWT.CHECK | SWT.LEFT);
			...
			{
				cobraSourceCheckbox = new Button(transactionSourceGroup, SWT.CHECK | SWT.LEFT);
