...
*/
public class TransactionTableComposite extends org.eclipse.swt.custom.SashForm {

	AbstractTransactionTable transactionTable;
	TransactionComposite transactionComposite;
	TableItem lastSelectedItem;
	
	public TransactionTableComposite(Composite parent, int style, AbstractTransactionTable transactionTable) 
	{
