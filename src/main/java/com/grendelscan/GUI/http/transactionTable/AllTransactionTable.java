...
public class AllTransactionTable extends AbstractTransactionTable
{
	...
	public AllTransactionTable(Composite parent, int style)
	{
	...
	protected int initGUIStart(int top)
	{
		...
		top += 35;
		{
			settingsButton = new Button(this, SWT.PUSH | SWT.CENTER);
		...
		{
			exportDisplayedButton = new Button(this, SWT.PUSH | SWT.CENTER);
		...
		{
			exportAllButton = new Button(this, SWT.PUSH | SWT.CENTER);
		...
		{
			Label transactionCountLabel = new Label(this, SWT.NONE);
			...
			transactionCountLabel.setFont(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
		}
		{
			transactionCountTextBox = new Text(this, SWT.READ_ONLY | SWT.BORDER);
			transactionCountTextBox.setBackground(SWTResourceManager.getColor(255, 255, 255));
			...
			transactionCountTextBox.setFont(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
		}
		return top;
	}
