...
*/
public class AmfViewComposite extends Composite implements ParsedEntityComposite 
{
	...
	public AmfViewComposite(org.eclipse.swt.widgets.Composite parent, int style, boolean editable) {
		super(parent, style);
...
//						}
	...
	private class TextControl extends EditControl
	{
		...
		public TextControl()
		{
			textbox = new Text(composite, SWT.NONE);
		}
...
//        }
	...
	protected void handleEditClick(final TreeItem treeItem, final int column, final EditControl control)
	{
		if (treeItem != null ) 
		{
			...
			final Composite composite = control.getComposite();
			if (showBorder) 
