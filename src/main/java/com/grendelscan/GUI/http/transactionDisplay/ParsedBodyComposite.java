...
*/
public class ParsedBodyComposite extends org.eclipse.swt.widgets.Composite {
	protected Button hexEncodedRadioButton;
	protected Button rawEncodedRadio;
	...
	protected ArrayList<Button> optionalParsingButtons;
	...
	public ParsedBodyComposite(Composite parent, int style, boolean editable) 
	{
		super(parent, style);
		this.editable = editable;
		optionalParsedComposites = new ArrayList<ParsedEntityComposite>(1);
		optionalParsingButtons = new ArrayList<Button>(1);
		body = new byte[0];
		initGUI();
		restoreView();
	}
	...
	protected void changeButtonSelection(Button button, boolean useActiveControl)
	{
	...
	{
		boolean selected = ((Button)event.getSource()).getSelection();
		if (selected) 
		{
			changeButtonSelection((Button) event.widget, true);
		}
	}
	...
	{
		saveView();
		for (Button button: optionalParsingButtons)
		{
			...
			{
				{
					...
					Button urlEncodedRadioButton = new Button(this, SWT.RADIO | SWT.LEFT);
...
//			{
//				multiPartRadioButton = new Button(this, SWT.RADIO | SWT.LEFT);
...
//			}
		}
		{
			if (contentCategory == HttpContentTypeCategory.AMF)
			{
				...
				Button amfEncodedRadioButton = new Button(this, SWT.RADIO | SWT.LEFT);
		...
		if (contentCategory == HttpContentTypeCategory.HTML)
		{
			...
			Button htmlEncodedRadioButton = new Button(this, SWT.RADIO | SWT.LEFT);
...
//		{
//			imageEncodedRadio = new Button(this, SWT.RADIO | SWT.LEFT);
...
//		}
	...
	protected void initGUI() 
	{
		...
		int currentLeft = 0;
		{
			...
			{
				hexEncodedRadioButton = new Button(this, SWT.RADIO | SWT.LEFT);
			...
			{
				rawEncodedRadio = new Button(this, SWT.RADIO | SWT.LEFT);
