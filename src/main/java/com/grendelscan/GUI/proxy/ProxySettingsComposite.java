...
public class ProxySettingsComposite extends org.eclipse.swt.widgets.Composite implements GrendelSettingsControl{


	private Button	revealHiddenFieldsButton;
	private Button	testProxyRequestsCheckbox;
	private Button	allowAllProxyRequests;
	private Button	testIntecptedRequestsCheckbox;
	private Group	proxySettingsGroup;
	private ProxyBindingsComposite	proxyBindingsComposite;
	

	public ProxySettingsComposite(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
			...
			{
				revealHiddenFieldsButton = new Button(this, SWT.CHECK | SWT.LEFT);
			...
			{
				testProxyRequestsCheckbox = new Button(this, SWT.CHECK | SWT.LEFT);
			...
			{
				allowAllProxyRequests = new Button(this, SWT.CHECK | SWT.LEFT);
			...
			{
				testIntecptedRequestsCheckbox = new Button(this, SWT.CHECK | SWT.LEFT);
			...
			{
				proxySettingsGroup = new Group(this, SWT.NONE);
...
//				}
//				{
//					maxProxyThreadLabel = new Label(proxySettingsGroup, SWT.NONE);
...
//				}
//				{
//					maxProxyThreadTextBox = new Text(proxySettingsGroup, SWT.BORDER);
...
//				}
//				{
//					restartProxyButton = new Button(proxySettingsGroup, SWT.PUSH | SWT.CENTER);
