...
*/
public class PresetStringComposite extends org.eclipse.swt.widgets.Composite implements FuzzVectorComposite
{
	private Group fileImportGroup;
	private Text seperatorStringTextbox;
	private Button importFromFileButton;
	Button newLineCheckbox;
	private Label seperatorStringLabel;
	private AddRemoveListComposite list;

	public PresetStringComposite(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
			...
			{
				fileImportGroup = new Group(this, SWT.NONE);
				...
				{
					newLineCheckbox = new Button(fileImportGroup, SWT.CHECK | SWT.LEFT);
				...
				}
				{
					...
					seperatorStringTextbox = new Text(fileImportGroup, SWT.BORDER);
					seperatorStringTextbox.setLayoutData(seperatorStringTextboxLData);
				}
				{
					seperatorStringLabel = new Label(fileImportGroup, SWT.NONE);
				...
				{
					importFromFileButton = new Button(fileImportGroup, SWT.PUSH | SWT.CENTER);
