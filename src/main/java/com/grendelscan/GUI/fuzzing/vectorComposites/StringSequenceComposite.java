...
*/
public class StringSequenceComposite extends org.eclipse.swt.widgets.Composite implements FuzzVectorComposite
{
	private Group charactersGroup;
	Text hexCharactersTextbox;
	private Text textCharactersTextBox;
	private Text maxDigitsTextbox;
	private Label maxDigitsLabel;
	private Text minDigitsTextbox;
	private Label minDigitsLabel;
	Combo definedCombo;
	private Label textCharactersLabel;
	private Label hexCharactersLabel;
	Map<String, Preset> presets;
	boolean changing = false;

	public StringSequenceComposite(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
			...
			{
				minDigitsTextbox = new Text(this, SWT.BORDER);
			...
			{
				maxDigitsTextbox = new Text(this, SWT.BORDER);
			...
			{
				minDigitsLabel = new Label(this, SWT.NONE);
			...
			{
				charactersGroup = new Group(this, SWT.NONE);
				...
				}
				{
					...
					textCharactersTextBox = new Text(charactersGroup, SWT.WRAP | SWT.V_SCROLL | SWT.BORDER);
				...
				}
				{
					...
					hexCharactersTextbox = new Text(charactersGroup, SWT.WRAP | SWT.V_SCROLL | SWT.BORDER);
				...
				{
					hexCharactersLabel = new Label(charactersGroup, SWT.NONE);
				...
				{
					textCharactersLabel = new Label(charactersGroup, SWT.NONE);
					...
					textCharactersLabel.setText("Text Characters:");
				}
			}
			{
				maxDigitsLabel = new Label(this, SWT.NONE);
