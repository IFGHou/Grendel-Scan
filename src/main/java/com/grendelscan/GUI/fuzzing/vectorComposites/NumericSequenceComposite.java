...
*/
public class NumericSequenceComposite extends org.eclipse.swt.widgets.Composite implements FuzzVectorComposite 
{
	private Label beginLabel;
	private Label decimalPlacesLabel;
	private Text decimalPlacesTextBox;
	private Combo ascendingCombo;
	private Text incrementTextBox;
	private Label incrementLabel;
	private Text endTextBox;
	private Text beginTextBox;
	private Label endLabel;


	public NumericSequenceComposite(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		initGUI();
	}
	...
	private void initGUI() {
			...
			{
				decimalPlacesLabel = new Label(this, SWT.WRAP);
			...
			{
				incrementLabel = new Label(this, SWT.NONE);
			...
			}
			{
				...
				beginTextBox = new Text(this, SWT.BORDER);
			...
			}
			{
				...
				endTextBox = new Text(this, SWT.BORDER);
			...
			}
			{
				...
				incrementTextBox = new Text(this, SWT.BORDER);
			...
			}
			{
				...
				decimalPlacesTextBox = new Text(this, SWT.BORDER);
