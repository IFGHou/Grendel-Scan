...
import com.grendelscan.GUI.http.transactionTable.FuzzerResultsTable;
...
public class FuzzerComposite extends org.eclipse.swt.widgets.Composite implements GrendelSettingsControl{
	...
	private Button	fuzzTemplateButton;
	private Button	fuzzVectorButton;
	private Button	fuzzCriteriaButton;
	private Label	maxFuzzRequestsLabel;
	private Text	maxFuzzRequestsTextbox;
	Button	startFuzzButton;
	private Button	stopFuzzButton;
	private Button	clearTableButton;
	private FuzzerResultsTable	fuzzResultsTable;
	Fuzzer fuzzer;
	

	public FuzzerComposite(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	...
	private void initGUI() {
			...
			{
				fuzzTemplateButton = new Button(this, SWT.PUSH | SWT.CENTER);
			...
			{
				fuzzVectorButton = new Button(this, SWT.PUSH | SWT.CENTER);
			...
			{
				fuzzCriteriaButton = new Button(this, SWT.PUSH | SWT.CENTER);
			...
			{
				maxFuzzRequestsLabel = new Label(this, SWT.NONE);
			...
			{
				maxFuzzRequestsTextbox = new Text(this, SWT.BORDER);
				...
				maxFuzzRequestsTextbox.addVerifyListener(GUIConstants.integersOnlyVerifyer);
			}
			{
				startFuzzButton = new Button(this, SWT.PUSH | SWT.CENTER);
			...
			{
				stopFuzzButton = new Button(this, SWT.PUSH | SWT.CENTER);
			...
			{
				clearTableButton = new Button(this, SWT.PUSH | SWT.CENTER);
	...
	protected void startFuzzer()
	{
		...
		{
			fuzzer = new Fuzzer(fuzzVector, Integer.valueOf(maxFuzzRequestsTextbox.getText()), 
					FuzzTemplateComposite.fuzzTemplateText, fuzzFilters, usePlatformErrors, this);
