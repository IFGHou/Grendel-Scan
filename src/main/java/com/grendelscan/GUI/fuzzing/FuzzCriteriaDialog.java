...
*/
public class FuzzCriteriaDialog extends org.eclipse.swt.widgets.Dialog {
	protected Shell dialogShell;
	protected Button platformErrorCheckbox;
	 ...
	 */
	public static boolean showGUI(Shell parent, final List<InterceptFilter> filters, final boolean usePlatformErrors) 
	{
		FuzzCriteriaDialog inst = new FuzzCriteriaDialog(parent, SWT.NULL, filters, usePlatformErrors);
		return inst.usePlatformErrors;
	}

	private FuzzCriteriaDialog(Shell parent, int style, final List<InterceptFilter> filters, boolean usePlatformErrors) 
	{
		super(parent, style);
	...
	private void initGUI() {
			...
			{
				closeButton = new Button(dialogComposite, SWT.PUSH | SWT.CENTER);
			...
			{
				platformErrorCheckbox = new Button(dialogComposite, SWT.CHECK | SWT.LEFT);
