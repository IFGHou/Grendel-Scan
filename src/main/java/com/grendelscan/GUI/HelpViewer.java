...
public class HelpViewer implements Runnable
{
	...
	private class HelpSection implements MouseListener
	{
		...
		public void clicked()
		{
			...
			{
				selectedLabel.setForeground(SWTResourceManager.getColor(0, 0, 0));
			}
			selectedLabel = label;
	...
	private class HelpViewerComposite extends Composite
	{
...
//		}
		...
		public HelpViewerComposite(Composite parent, int style)
		{
			super(parent, style);
			initGUI();
		}
...
*/
	...
	public void run()
	{
		...
		shell.setFont(SWTResourceManager.getFont(GUIConstants.fontName, GUIConstants.fontSize, 0, false, false));
