...
*/
public class MainWindow extends org.eclipse.swt.widgets.Composite implements GrendelSettingsControl
{
	...
	public void showFullGUI()
	{
		...
		shell.open();
//		this.getDisplay().timerExec(5000, new Runnable()
//		{
//			
//			@Override
//			public void run()
//			{
//				transactionsTableComposite.refreshData();
//			}
//		});
	...
	private MainWindow(Composite parent, int style) 
	{
		super(parent, style);
		exiting = false;
	}
	...
	public void initFullGUI() 
	{
			...
			mainTabs = new TabFolder(this, SWT.NONE);
			mainTabs.setFont(GUIConstants.getFont(2));
			{
...
//					synchronized(this)
	...
	public final TabFolder getMainTabs()
	{
		return mainTabs;
	}
