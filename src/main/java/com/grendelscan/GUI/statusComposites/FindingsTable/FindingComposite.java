 ...
 */
public class FindingComposite extends org.eclipse.swt.widgets.Composite
{
	...
	private Label urlsLabel;
	private Browser recomendationText;
	private Label recomendationLabel;
	...
	private FindingComposite(org.eclipse.swt.widgets.Composite parent, int style, Finding finding)
	{
		super(parent, style);
	...
	private void initGUI()
	{
		try
		{
			...
			{
				referencesLabel = new Label(this, SWT.NONE);
			...
			{
				recomendationLabel = new Label(this, SWT.NONE);
			...
			}
			{
				...
				urlsText = new Text(this, SWT.MULTI | SWT.READ_ONLY | SWT.WRAP | SWT.BORDER);
				urlsText.setLayoutData(urlsTextLData);
				urlsText.setText(finding.getUrl());
			}
			{
				urlsLabel = new Label(this, SWT.NONE);
			...
			{
				sourceText = new Text(this, SWT.READ_ONLY | SWT.BORDER);
			...
			}
			{
				...
				riskText = new Text(this, SWT.READ_ONLY | SWT.BORDER);
			...
			}
			{
				...
				titleText = new Text(this, SWT.READ_ONLY | SWT.BORDER);
			...
			{
				sourceLabel = new Label(this, SWT.NONE);
			...
			{
				riskLabel = new Label(this, SWT.NONE);
