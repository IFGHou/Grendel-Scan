...
public class MimeUtils
{
	...
	/**
     * Anything that could be remotely web-related. HTML, XHTML, XML,
     * CSS, text, javascript, vbscript, and json
     * @param mimeType
     * @return
     */
    public static boolean isWebTextMimeType(String mimeType)
    {
    	boolean html = false;
    	String m = mimeType.toLowerCase();
    	if (
    			isHtmlMimeType(m) 
    			|| isJavaScriptMimeType(m) 
    			|| m.contains("xml") 
    			|| m.equals("application/vbscript") 
    			|| m.equals("text/vbscript")
    			|| m.equals("text/css") 
    			|| m.equals("text/plain")
    			|| m.isEmpty()
    			)
    ...
    public static boolean isUrlEncoded(String mimeType)
    {
    ...
    public static boolean isAmf(String mimeType)
    {
    	return mimeType.toLowerCase().equals("application/x-amf");
    }
    
    public static boolean treatAsXml(String mimeType)
    {
    	String m = mimeType.toLowerCase();
	...
	{
		return new String[] {"application/javascript", "application/json", "application/x-javascript", 
				"application/ecmascript", "text/ecmascript", "text/javascript"};
	}
	...
	public static String getFileExtension(String mimeType)
	{
		...
		else if (mimeType.equals("application/x-troff-msvideo") 
