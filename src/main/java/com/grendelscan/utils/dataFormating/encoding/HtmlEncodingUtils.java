 ...
 * 
 */
package com.grendelscan.utils.dataFormating.encoding;
...
public class HtmlEncodingUtils
{
	 ...
	 * @return
	 */
	public static byte[] decodeHtml(byte[] data)
	{
	...
	public static byte[] encodeFullHtml(byte[] data)
	{
	...
	public static byte[] encodeHtmlDefault(byte[] data)
	{
		...
		{
			Log.error("Very weird problem encoding HTML: " + e.toString(), e);
		}
		return out.toByteArray();
	}
	
	public static void encodeHtmlDefault(OutputStream out, byte[] data) throws IOException 
	{
		for(byte b: data)
		{
    ...
    private static final int getEntityChar(String spec) 
	{
