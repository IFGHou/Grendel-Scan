...
//		{
//			Log.fatal("Problem with creating database: " + e.toString(), e);
//			System.exit(1);
//		}
//	}
//	
...
//		catch (SQLException e) 
//		{
//			Log.fatal("Problem with emptying database: " + e.toString(), e);
//			System.exit(1);
//		}
//	}
//
...
//        catch (SQLException e)
//        {
//			Log.error("Problem storing test job group in database: " + e.toString(), e);
//        }
//        catch (IOException e)
//        {
//			Log.error("Problem storing test job group in database: " + e.toString(), e);
...
//        catch (SQLException e)
//        {
//			Log.error("Problem loading test group from database: " + e.toString(), e);
//        }
//        catch (IOException e)
//        {
//			Log.error("Problem loading test group from database: " + e.toString(), e);
