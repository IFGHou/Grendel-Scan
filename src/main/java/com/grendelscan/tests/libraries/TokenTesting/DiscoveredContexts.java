...
//	}
	...
	public DiscoveredContexts getAllOfToken(String token)
	{
	...
	public DiscoveredContexts getAllOfType(TokenContextType type)
	{
		DiscoveredContexts newContexts = new DiscoveredContexts();
	...
	public void addContext(TokenContext context)
	{
		count++;
