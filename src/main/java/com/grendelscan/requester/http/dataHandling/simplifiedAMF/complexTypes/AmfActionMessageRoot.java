...
public class AmfActionMessageRoot extends AbstractAmfDataContainer<AmfActionMessageRootComponentReference>
{
	...
	public AmfActionMessageRoot(ActionMessage message, int transactionId)
	{
		...
		for (Object o: message.getBodies())
		{
			...
			addBody(new AmfBody(body, this, new NumberedListDataReference(i++), transactionId, this));
		}
		i = 0;
		for (Object o: message.getHeaders())
		{
			headers.addChild(new AmfActionMessageHeader((MessageHeader) o, this, new NumberedListDataReference(i++), transactionId, this));
		}
	...
	{
		super("Main message", AmfDataType.kAmfMessageRoot, null, version == 3, new TransactionDataReference(true), transactionId);
		this.version = version;
		bodies = new AmfMessageBodies(this, AmfActionMessageRootComponentReference.BODIES, transactionId, this);
		headers = new AmfMessageHeaders(this, AmfActionMessageRootComponentReference.HEADERS, transactionId, this);
	}
