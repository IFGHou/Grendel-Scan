...
public class AmfByteArray extends AbstractAmfData
{
	...
	public AmfByteArray(String name, AbstractAmfDataContainer<?> parent, DataReference reference, int transactionId)
	{
		super(name, AmfDataType.kByteArray, parent, false, reference, transactionId);
		data = new ArrayList<Byte>(1);
	}
	
	public AmfByteArray(String name, byte[] bytes, AbstractAmfDataContainer<?> parent, DataReference reference, int transactionId)
	{
