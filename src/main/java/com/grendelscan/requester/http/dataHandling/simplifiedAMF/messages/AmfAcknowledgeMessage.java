...
public class AmfAcknowledgeMessage extends AmfAsyncMessage
{
	...
	public AmfAcknowledgeMessage(String name, AcknowledgeMessage message, String className, AbstractAmfDataContainer<?> parent, DataReference reference, int transactionId)
	{
		super(name, message, AmfDataType.kAmfAcknowledgeMessage, className, parent, reference, transactionId);
	}
	
	protected AmfAcknowledgeMessage(String name, AcknowledgeMessage message, AmfDataType type, String className, AbstractAmfDataContainer<?> parent, DataReference reference, int transactionId)
	{
