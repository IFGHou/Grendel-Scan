...
public class AmfDoubleArray extends AmfPrimitiveArray
{
	...
	public AmfDoubleArray(String name, AbstractAmfDataContainer<?> parent, DataReference reference, int transactionId, AmfActionMessageRoot amfRoot)
	{
		super(name, AmfDataType.kDoubleArray, parent, reference, transactionId);
	}
