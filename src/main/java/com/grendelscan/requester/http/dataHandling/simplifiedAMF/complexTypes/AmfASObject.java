...
public class AmfASObject extends AmfAssociativeArrayData implements AmfGenericObject
{
	...
	public AmfASObject(String name, AbstractAmfDataContainer<?> parent, DataReference reference, int transactionId)
	{
		super(name, parent, reference, transactionId);
		setType(AmfDataType.kASObject);
	}
	
	public AmfASObject(String name, ASObject object, AbstractAmfDataContainer<?> parent, DataReference reference, int transactionId)
	{
		super(name, object, parent, reference, transactionId);
		setType(AmfDataType.kASObject);
