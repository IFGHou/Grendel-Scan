...
public class AmfMessageHeaders extends AmfObjectArray
{
	...
	public AmfMessageHeaders(AbstractAmfDataContainer<?> parent, DataReference reference, int transactionId, AmfActionMessageRoot amfRoot)
	{
		super("Message headers", AmfDataType.kAmfMessageHeaders, parent, reference, transactionId);
	}
