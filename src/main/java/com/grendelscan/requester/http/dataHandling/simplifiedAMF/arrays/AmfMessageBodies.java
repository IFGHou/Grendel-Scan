...
public class AmfMessageBodies extends AmfObjectArray
{
	...
	public AmfMessageBodies(AbstractAmfDataContainer<?> parent, DataReference reference, int transactionId, AmfActionMessageRoot amfRoot)
	{
		super("Message bodies", AmfDataType.kAmfMessageBodies, parent, reference, transactionId);
	}
