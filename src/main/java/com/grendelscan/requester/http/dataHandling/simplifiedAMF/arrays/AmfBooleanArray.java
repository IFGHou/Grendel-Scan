...
public class AmfBooleanArray extends AmfPrimitiveArray
{
	...
	public AmfBooleanArray(String name, AbstractAmfDataContainer<?> parent, DataReference reference, int transactionId)
	{
		super(name, AmfDataType.kBooleanArray, parent, reference, transactionId);
	}
