 ...
 * <code>THEAD</code>, and <code>TFOOT</code> elements may exist in a
 * table. Therefore, if one exists, and the createTHead() or createTFoot()
 * method is called, the method returns the existing THead or TFoot element. See
 * the TABLE element definition in HTML 4.01.
 * <p>
 * See also the <a
