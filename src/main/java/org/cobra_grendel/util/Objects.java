...
public class Objects
{
	...
	public static boolean isAssignableOrBox(Object value, Class clazz)
	{
		return clazz.isInstance(value)
		        || (clazz.isPrimitive() && (((clazz == double.class) && (value instanceof Double))
		                ...
		                || ((clazz == long.class) && (value instanceof Long)) || ((clazz == float.class) && (value instanceof Float))))
		        || (isNumeric(clazz) && isNumeric(value));
	}
	
	public static boolean isBoxClass(Class clazz)
	{
		return (clazz == Integer.class) || (clazz == Boolean.class) || (clazz == Double.class)
		        || (clazz == Float.class) || (clazz == Long.class) || (clazz == Byte.class) || (clazz == Short.class)
