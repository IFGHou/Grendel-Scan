...
public abstract class NodeImpl extends AbstractScriptableDelegate implements Node, ModelNode
{
	...
	public NodeImpl(int transactionId)
	{
		super(transactionId);
	}
	...
	/**
	 * Gets descendent nodes that match according to the filter, but it does not
	 * nest into matching nodes.
	 */
	 ...
	 */
	@Override public Object getDocumentItem(String name)
	{
	 ...
	 */
	@Override public URL getFullURL(String spec) throws MalformedURLException
	{
		Object doc = document;
		if (doc instanceof HTMLDocumentImpl)
		{
	...
	@Override public abstract String getNodeValue() throws DOMException;
	...
	@Override public final ModelNode getParentModelNode()
	{
	 ...
	 */
	@Override public final boolean isEqualOrDescendentOf(ModelNode otherContext)
	{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.xamjwg.html.renderer.RenderableContext#setDocumentItem(java.lang.String,
	 *      java.lang.Object)
	 */
	@Override public void setDocumentItem(String name, Object value)
	{
		org.w3c.dom.Document document = this.document;
		if (document == null)
		{
	...
	@Override public abstract void setNodeValue(String nodeValue) throws DOMException;
	...
	@Override public void warn(String message, Throwable err)
	{
	...
	/**
	 * Sets the document node to null. This is so a single element
	 * can be referenced without retaining the entire DOM. If you start calling
	 * stuff that references parent nodes, ancestors, etc, expect a null 
	 * reference exception. 
	 * @param recursive
	 */
