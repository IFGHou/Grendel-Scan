...
public class HTMLTableCellElementImpl extends HTMLAbstractUIElement implements HTMLTableCellElement
{
	...
	public HTMLTableCellElementImpl(String name, int transactionId)
	{
		super(name, transactionId);
	}
	
	@Override public String getAbbr()
	{
	...
	@Override public String getAxis()
	{
	...
	@Override public String getCh()
	{
		return getAttribute("ch");
	}
	
	@Override public String getChOff()
	{
		return getAttribute("choff");
	}
	
	@Override public int getColSpan()
	{
	...
	@Override public String getHeaders()
	{
	...
	@Override public boolean getNoWrap()
	{
	...
	@Override public String getVAlign()
	{
	...
	@Override public void setAbbr(String abbr)
	{
	...
	@Override public void setAxis(String axis)
	{
	...
	@Override public void setColSpan(int colSpan)
	{
		setAttribute("colspan", String.valueOf(colSpan));
	}
	
	@Override public void setHeaders(String headers)
	{
	...
	@Override public void setNoWrap(boolean noWrap)
	{
		setAttribute("nowrap", noWrap ? "nowrap" : null);
	}
	
	@Override public void setRowSpan(int rowSpan)
	{
