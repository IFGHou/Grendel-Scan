...
public class HTMLAppletElementImpl extends HTMLAbstractUIElement implements HTMLAppletElement
{
	...
	public HTMLAppletElementImpl(String name, int transactionId)
	{
	...
	@Override public String getHspace()
	{
	...
	@Override public String getVspace()
	{
	...
	@Override public void setAlt(String alt)
	{
	...
	@Override public void setHspace(String hspace)
	{
	...
	@Override public void setVspace(String vspace)
	{
