...
/**
 * The <code>HtmlParser</code> class is an HTML DOM parser. This parser
 * provides the functionality for the standard DOM parser implementation
 * {@link org.cobra_grendel.html.parser.DocumentBuilderImpl}. This parser class
...
public class HtmlParser
{
	...
	/**
	 * Parses HTML given by a <code>Reader</code>. This method appends nodes
	 * to the document provided to the parser.
	 * 
	 * @param reader
									...
									for (;;)
									{
										try
										{
											...
											if ((einfo != null) && einfo.noScriptElement)
											{
												...
												{
													token =
													        parseForEndTag(parent, reader, tag, false,
											...
											{
												token =
												        childrenOk ? parseToken(element, reader, newStopSet, ancestors)
											...
											if (token == TOKEN_END_ELEMENT)
											{
												...
												{
													ElementInfo closeTagInfo =
													        (ElementInfo) ELEMENT_INFOS.get(normalLastTag);
										...
										catch (StopException se)
										{
											...
											endTagType =
											        einfo == null ? ElementInfo.END_ELEMENT_REQUIRED
