 ...
 * {@link org.cobra_grendel.html.HtmlRendererContext} interface. Note that this
...
public class SimpleHtmlRendererContext implements HtmlRendererContext
{
	...
	/**
	 * Constructs a simple <code>HtmlRendererContext</code> without a parent.
	 * This constructor should not be used to create the context of a frame with
	 * a parent.
	 * 
	 * @param contextComponent
	 * @param pcontext
	 ...
	 */
	@Deprecated
	public SimpleHtmlRendererContext(HtmlParserContext pcontext)
	{
		this(pcontext, null);
	}
	 ...
	 */
	@Deprecated
	public SimpleHtmlRendererContext(HtmlParserContext pcontext, HtmlRendererContext parentRcontext)
	{
		super();
	 ...
	 *            contexts would have parents.
	 */
	public SimpleHtmlRendererContext(HtmlRendererContext parentRcontext)
	{
		super();
		this.parentRcontext = parentRcontext;
	}
	 ...
	 */
	@Override public BrowserFrame createBrowserFrame()
	{
		return null;
	}
	...
	@Override public String getDefaultStatus()
	{
	 ...
	 */
	@Override public HTMLCollection getFrames()
	{
		/*
		 * Object rootNode = this.htmlPanel.getRootNode();
		 * 
		 * if(rootNode instanceof HTMLDocumentImpl) { return ((HTMLDocumentImpl)
		 * rootNode).getFrames(); } else { return null; }
		 */
		return null;
	}
	
	@Override public HtmlObject getHtmlObject(HTMLElement element)
	{
		HtmlObject result;
	...
	@Override public HtmlRendererContext getOpener()
	{
		return opener;
	}
	
	@Override public HtmlRendererContext getParent()
	{
	...
	@Override public HtmlRendererContext getTop()
	{
	...
	@Override public UserAgentContext getUserAgentContext()
	{
	...
	@Override public boolean isMedia(String mediaName)
	{
	 ...
	 */
	@Override public boolean isVisitedLink(HTMLLinkElement link)
	{
		// TODO
		return false;
	}
	 ...
	 * </ul>
	 */
	@Override public void navigate(final URL href, String target, final int referingTransactionId)
	{
				...
				try
				{
					...
					try
					{
						...
						HTMLDocumentImpl document =
						        (HTMLDocumentImpl) builder.createDocument(new InputSourceImpl(bin, actualURI,
						                "ISO-8859-1"), referingTransactionId);
	...
	@Override public HtmlRendererContext open(java.net.URL url, String windowName, String windowFeatures, boolean replace)
	{
		return null;
	}
	
	@Override public HtmlRendererContext open(String url, String windowName, String windowFeatures, boolean replace)
	{
		return null;
	}
	
	@Override public String prompt(String message, String inputDefault)
	{
		return "";
	}
	...
	@Override public void setDefaultStatus(String message)
	{
		this.warn("setDefaultStatus(): Not overridden.");
	}
	
	@Override public void setOpener(HtmlRendererContext opener)
	{
		this.opener = opener;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.xamjwg.html.HtmlContext#submitForm(java.lang.String,
	 *      java.lang.String, java.lang.String, java.lang.String,
	 *      org.xamjwg.html.FormInput[])
	 */
	@Override public void submitForm(String method, java.net.URL action, String target, String enctype, FormInput[] formInputs)
	{
	...
	/**
	 * This method is called by the local navigate() implementation and creates
	 * a {@link SimpleHtmlParserContext}. Override this method if you need to
	 * use the local navigate() implementation with an overridden parser
	 * context.
	 */
