        ...
        SubscriptionManagerControlMBean
{
     ...
     */
    @Override public Integer getSubscriberCount()
    {
     ...
     */
    @Override public String[] getSubscriberIds()
    {
        Set subscriberIds = subscriptionManager.getSubscriberIds();
        if (subscriberIds != null)
        {
     ...
     */
    @Override public void removeSubscriber(String subscriberId)
    {
     ...
     */
    @Override public void removeAllSubscribers()
    {
