        ...
        MessageDestinationControlMBean
{
     ...
     */
    @Override public ObjectName getMessageCache()
    {
        return messageCache;
    }
     ...
     */
    @Override public ObjectName getThrottleManager()
    {
     ...
     */
    @Override public ObjectName getSubscriptionManager()
    {
     ...
     */
    @Override public Integer getServiceCommandCount()
    {        
     ...
     */
    @Override public void resetServiceCommandCount()
    {
     ...
     */
    @Override public Date getLastServiceCommandTimestamp()
    {
     ...
     */
    @Override public Double getServiceCommandFrequency()
    {
     ...
     */
    @Override public Integer getServiceMessageFromAdapterCount()
    {
     ...
     */
    @Override public void resetServiceMessageFromAdapterCount()
    {
     ...
     */
    @Override public Date getLastServiceMessageFromAdapterTimestamp()
    {
     ...
     */
    @Override public Double getServiceMessageFromAdapterFrequency()
    {
