...
{   
     ...
     */
    @Override public Integer getMaxStreamingClients() 
    {
     ...
     */
    @Override public Integer getPushCount()
    {
     ...
     */
    @Override public void resetPushCount()
    {
     ...
     */
    @Override public Date getLastPushTimestamp()
    {
     ...
     */
    @Override public Double getPushFrequency()
    {
        if (pushCount > 0)
        {
     ...
     */
    @Override public Integer getStreamingClientsCount()
    {
