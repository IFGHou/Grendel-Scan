...
public abstract class AbstractTarget implements Target
{
     ...
     */
    @Override public List getFilters()
    {
     ...
     */
    @Override public void addFilter(String value)
    {
        if (value != null)
     ...
     */
    @Override public void removeFilter(String value)
    {
     ...
     */
    @Override public void setFilters(List value)
    {
     ...
     */
    @Override public short getLevel()
    {
        return level;
    }
     ...
     */
    @Override public void setLevel(short value)
    {
        level = value;
     ...
     */
    @Override public void addLogger(Logger logger)
    {
        if (logger != null)
        {
            synchronized (lock)
     ...
     */
    @Override public void removeLogger(Logger logger)
    {
        if (logger != null)
        {
            synchronized (lock)
