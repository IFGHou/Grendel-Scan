...
public class RemotingDestination extends FactoryDestination
{
     ...
     * 
     * @param serverId id of the server containing the remoting destination to be retrieved.
     * @param destinationName Name of the remoting destination to be retrieved.
     * 
     ...
     */
    @Override public String getLogCategory()
    {
        return LOG_CATEGORY;
    }    
     ...
     */
    @Override protected void setupDestinationControl(Service service)
    {
