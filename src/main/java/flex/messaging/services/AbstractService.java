...
public abstract class AbstractService extends ManageableComponent implements Service
{
     ...
     */
    @Override public Map getRegisteredAdapters()
    {
     ...
     */
    @Override public String registerAdapter(String id, String adapterClass)
    {
     ...
     */
    @Override public String unregisterAdapter(String id)
    {
     ...
     */
    @Override public void setDefaultAdapter(String id)
    {
     ...
     */
    @Override public List getDefaultChannels()
    {
     ...
     */
    @Override public void addDefaultChannel(String id)
    {
        if (defaultChannels == null)
     ...
     */
    @Override public void setDefaultChannels(List ids)
    {
     ...
     */
    @Override public boolean removeDefaultChannel(String id)
    {
        if (defaultChannels == null)
            return false;
     ...
     */
    @Override public Destination getDestination(Message message)
    {
     ...
     */
    @Override public Destination getDestination(String id)
    {
     ...
     */
    @Override public Map getDestinations()
    {
        return destinations;
    }
     ...
     */
    @Override public Destination removeDestination(String id)
    {
     ...
     */
    @Override public MessageBroker getMessageBroker()
    {
     ...
     */
    @Override public void setMessageBroker(MessageBroker broker)
    {
     ...
     */
    @Override public ConfigMap describeService(Endpoint endpoint)
    {
        return null;
    }
     ...
     */
    @Override public abstract Object serviceMessage(Message message);

    @Override public Object serviceCommand(CommandMessage message)
    {
