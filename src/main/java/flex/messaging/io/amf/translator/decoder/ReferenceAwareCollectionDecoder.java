...
public class ReferenceAwareCollectionDecoder extends CollectionDecoder
{
     ...
     * all of the contents.
     */
    @Override protected boolean isSuitableCollection(Object encodedObject, Class desiredClass)
    {
        return false;
    }

    @Override protected Collection decodeCollection(Collection shell, Object encodedObject)
    {
