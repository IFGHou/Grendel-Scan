...
public class Amf0Output extends AbstractAmfOutput implements AmfTypes
{
     ...
     */
    @Override public void writeObject(Object o) throws IOException
    {
        if (o == null)
        {
            writeAMFNull();
     ...
     * @exclude
     */
    @Override public void writeObjectTraits(TraitsInfo traits) throws IOException
    {
     ...
     * @exclude
     */
    @Override public void writeObjectProperty(String name, Object value) throws IOException
    {
        if (isDebug)
     ...
     * @exclude
     */
    @Override public void writeObjectEnd() throws IOException
    {
