...
public abstract class AbstractMessage implements Message, Cloneable
{
    ...
    @Override public Object getClientId()
    {
        return clientId;
    }
    
    @Override public void setClientId(Object clientId)
    {
    ...
    @Override public void setBody(Object body)
    {
        this.body = body;
    }
    ...
    @Override public void setDestination(String destination)
    {
    ...
    @Override public void setHeaders(Map newHeaders)
    {
    ...
    @Override public Object getHeader(String headerName)
    {
        if (headers == null)
        {
            return null;
    ...
    @Override public void setHeader(String headerName, Object value)
    {
        if (headers == null)
        {
            headers = new HashMap();
    ...
    @Override public boolean headerExists(String headerName)
    {
