...
import com.grendelscan.smashers.jobs.ByDirectoryTestJob;
...
public class ByDirectoryCategorizer extends ByTokenCategorizer<StringToken>
{
    ...
    @Override
    protected Set<TestJob> makeTestJobs(final StandardHttpTransaction transaction, final AbstractSmasher module, final StringToken token)
    {
