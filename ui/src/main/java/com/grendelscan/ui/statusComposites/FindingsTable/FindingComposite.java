 ...
 */
public class FindingComposite extends com.grendelscan.ui.customControls.basic.GComposite
{

    public static void displayFinding(final Finding finding)
    {
    ...
    private FindingComposite(final com.grendelscan.ui.customControls.basic.GComposite parent, final int style, final Finding finding)
    {
        super(parent, style);
