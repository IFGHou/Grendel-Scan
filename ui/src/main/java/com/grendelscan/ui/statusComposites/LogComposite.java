package com.grendelscan.ui.statusComposites;
...
public class LogComposite extends com.grendelscan.ui.customControls.basic.GComposite
{
	...
	public LogComposite(com.grendelscan.ui.customControls.basic.GComposite parent, int style)
	{
		super(parent, style);
		initGUI();
	}
