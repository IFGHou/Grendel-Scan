...
public class ProxySettingsComposite extends com.grendelscan.ui.customControls.basic.GComposite implements GrendelSettingsControl
{
    ...
    public ProxySettingsComposite(final com.grendelscan.ui.customControls.basic.GComposite parent, final int style)
    {
        super(parent, style);
        initGUI();
    }

    protected void allowAllProxyRequestsWidgetSelected(final SelectionEvent evt)
    {
    ...
    private void initGUI()
    {
        ...
        }
        {
            ...
            // else
            // {
            // // Since this is really a start/stop GButton
            // scan.stopProxy();
            // }
            // updateProxyStatus();
            // }
    ...
    protected void revealHiddenFieldsButtonWidgetSelected(final SelectionEvent evt)
    {
