 ...
 */
public class HttpClientSettingsComposite extends com.grendelscan.ui.customControls.basic.GComposite implements GrendelSettingsControl
{
    ...
    public HttpClientSettingsComposite(final com.grendelscan.ui.customControls.basic.GComposite parent, final int style)
    {
        super(parent, style);
        initGUI();
    }

    private void addResponseCodeOverride(final String code, final String pattern)
    {
    ...
    private void initGUI()
    {
        ...
        }
        {
            ...
            miscHttpClientGroup.setFontf(GuiUtils.getFont(GuiUtils.fontName, GuiUtils.fontSize, 0, false, false));
            ...
            miscHttpClientGroup.setLayout(miscHttpClientGroupLayout);
            {
                ...
                useragentComboBox.setFontf(GuiUtils.getFont(GuiUtils.fontName, GuiUtils.fontSize, 0, false, false));
            ...
            }
            {
                ...
                useragentLabel.setFontf(GuiUtils.getFont(GuiUtils.fontName, GuiUtils.fontSize, 0, false, false));
            }
        }
        {
            ...
            responseCodeGroup.setFontf(GuiUtils.getFont(GuiUtils.fontName, GuiUtils.fontSize, 0, false, false));
            ...
            responseCodeGroup.setLayout(responseCodeGroupLayout);
            {
                ...
                useAutomaticOverridesCheckBox.setFontf(GuiUtils.getFont(GuiUtils.fontName, GuiUtils.fontSize, 0, false, false));
            ...
            }
            {
                ...
                testEveryDirectoryCheckBox.setFontf(GuiUtils.getFont(GuiUtils.fontName, GuiUtils.fontSize, 0, false, false));
            ...
            }
            {
                ...
                manualOverrideCodeLabel.setFontf(GuiUtils.getFont(GuiUtils.fontName, GuiUtils.fontSize, 0, false, false));
            }
            {
                ...
                manualOverrideRegexLabel.setFontf(GuiUtils.getFont(GuiUtils.fontName, GuiUtils.fontSize, 0, false, false));
            }
            {
                httpResponseCodeTextbox = new GText(responseCodeGroup, SWT.BORDER);
                httpResponseCodeTextbox.setFontf(GuiUtils.getFont(GuiUtils.fontName, GuiUtils.fontSize, 0, false, false));
            ...
            }
            {
                ...
                manualOverrideAddButton.addSelectionListener(new SelectionAdapter()
                {
                    ...
                    public void widgetSelected(final SelectionEvent event)
                    {
                        if (!httpResponseCodeTextbox.getText().equals("") && !regexOverrideTextbox.getText().equals("") && httpResponseCodeTextbox.getText().matches("[1-5]\\d{2}"))
                        {
                            if (!RegexUtils.validateRegex(regexOverrideTextbox.getText()))
                            {
                                MainWindow.getInstance().displayMessage("Error", "Invalid response code regular expression.", true);
                            }
                            else
                            {
                                addResponseCodeOverride(httpResponseCodeTextbox.getText(), regexOverrideTextbox.getText());
            ...
            }
            {
                ...
                manualOverrideRemoveButton.setFontf(GuiUtils.getFont(GuiUtils.fontName, GuiUtils.fontSize, 0, false, false));
            ...
            }
            {
                ...
                responseCodeOverrideTable.setFontf(GuiUtils.getFont(GuiUtils.fontName, GuiUtils.fontSize, 0, false, false));
