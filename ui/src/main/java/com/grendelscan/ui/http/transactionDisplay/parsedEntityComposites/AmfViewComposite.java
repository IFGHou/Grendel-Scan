...
import com.grendelscan.commons.flex.messages.CommandMessageTypeEnum;
...
public class AmfViewComposite extends GComposite implements ParsedEntityComposite
{
    ...
    {
        private Menu generateDataTypeSubMenu(final Menu parentMenu, final SelectionListener selectionListener, final AmfDataType[] types)
        {
        ...
        private void handleContextMenu(final TreeItem treeItem, final MouseEvent mouseEvent)
        {
            ...
            /*
             * This is really ugly, but I can't figure out how to get coordinates for the mouse event. The even only contains them relative to the widget. A normal event would give them on the screen.
             * AAAAHHHHHH!!!!!!
             */
        ...
        private void handleEdit(final TreeItem item, final Point point, @SuppressWarnings("unused") final MouseEvent event)
        {
            if (item == null)
            {
                return;
        ...
        @Override
        public void mouseDoubleClick(@SuppressWarnings("unused") final MouseEvent event)
        {
        ...
        @Override
        public void mouseUp(@SuppressWarnings("unused") final MouseEvent event)
        {
    ...
    {
        public DataTypeControl(final AmfDataType currentType)
        {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AmfViewComposite.class);
    ...
    public AmfViewComposite(final com.grendelscan.ui.customControls.basic.GComposite parent, final int style, final boolean editable)
    {
        super(parent, style);
    ...
    protected void deleteTreeData(final TreeItem treeItem)
    {
    ...
    protected void displayAmfData(final AbstractAmfData data, final TreeItem item, final String name)
    {
    ...
    protected void displayPrimitiveArray(final AmfPrimitiveArray array, final TreeItem item)
    {
        int pos = 0;
    ...
    protected String getNewName(final AbstractAmfNamedDataContainer collection)
    {
    ...
    protected void renumberArray(final TreeItem item)
    {
        int pos = 0;
    ...
    public void updateData(final byte[] data)
    {
        ...
        catch (EOFException eof)
        {
            ...
            LOGGER.error("Problem parsing AMF message for display", eof);
        }
        catch (ClassNotFoundException e)
        {
            e.printStackTrace();
            LOGGER.error("Problem parsing AMF message for display", e);
        }
        catch (IOException e)
        {
            e.printStackTrace();
