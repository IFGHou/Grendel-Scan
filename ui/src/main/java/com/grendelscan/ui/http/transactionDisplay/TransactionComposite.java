 ...
 */
public class TransactionComposite extends com.grendelscan.ui.customControls.basic.GComposite
{
    private static final Logger LOGGER = LoggerFactory.getLogger(TransactionComposite.class);
    ...
    private final boolean requestEditable;
    private final boolean responseEditable;
    ...
    public static void displayTransaction(final StandardHttpTransaction transaction, final boolean requestEditable, final boolean responseEditable)
    {
    ...
    public TransactionComposite(final GSashForm parent, final int style, final boolean requestEditable, final boolean responseEditable, final boolean showResponse)
    {
        super(parent, style);
    ...
    public TransactionComposite(final GShell parent, final int style, final boolean requestEditable, final boolean responseEditable, final boolean showResponse)
    {
        super(parent, style);
        this.requestEditable = requestEditable;
        this.responseEditable = responseEditable;
    ...
    public StandardHttpTransaction makeHttpRequest(final TransactionSource source) throws HttpFormatException, IOException, HttpException
    {
        if (parsedHttpRequest.isVisible())
        {
    ...
    public final void setShowResponse(final boolean showResponse)
    {
    ...
    protected void updateRequestControl(final boolean useActiveControl) throws URISyntaxException
    {
    ...
    public void updateRequestData(final byte[] newRawRequest) throws URISyntaxException
    {
        rawRequest = newRawRequest;
    ...
    protected void updateResponseControl(final boolean useActiveControl)
    {
    ...
    public void updateResponseData(final byte[] newRawResponse)
    {
        if (showResponse)
        {
    ...
    public void updateTransactionData(final byte[] newRawRequest, final byte[] newRawResponse) throws URISyntaxException
    {
