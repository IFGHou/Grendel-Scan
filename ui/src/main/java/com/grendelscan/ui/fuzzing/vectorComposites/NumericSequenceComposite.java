...
*/
public class NumericSequenceComposite extends com.grendelscan.ui.customControls.basic.GComposite implements FuzzVectorComposite 
{
	...
	public NumericSequenceComposite(com.grendelscan.ui.customControls.basic.GComposite parent, int style) {
		super(parent, style);
		initGUI();
	}
