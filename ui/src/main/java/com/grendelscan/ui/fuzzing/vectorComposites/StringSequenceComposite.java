 ...
 */
public class StringSequenceComposite extends com.grendelscan.ui.customControls.basic.GComposite implements FuzzVectorComposite
{
    private class Preset
    {
        String description, hex, text;

        public Preset(final String description, final String hex, final String text)
        {
            this.hex = hex;
            this.text = text;
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(StringSequenceComposite.class);
    ...
    public StringSequenceComposite(final com.grendelscan.ui.customControls.basic.GComposite parent, final int style)
    {
        super(parent, style);
        initGUI();
    }
    ...
    private void createPresets()
    {
        ...
        tmpPresets.add(new Preset(
                        "All ASCII characters - 0x00-0xff",
    ...
    @Override
    public void displayFuzzVector(final FuzzVector oldVector)
    {
