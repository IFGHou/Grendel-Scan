...
{
    private static final Logger LOGGER = LoggerFactory.getLogger(HtmlEncodingUtils.class);
    ...
    public static void encodeHtmlDefault(final OutputStream out, final byte[] data) throws IOException
    {
        for (byte b : data)
        {
