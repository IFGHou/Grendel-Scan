...
public class DocumentTypeImpl extends NodeImpl implements DocumentType
{
	...
	public DocumentTypeImpl(String qname, String publicId, String systemId, int transactionId)
	{
		super(transactionId);
		qualifiedName = qname;
	...
	@Override public NamedNodeMap getEntities()
	{
		// TODO: DOCTYPE declared entities
		return null;
	}
	
	@Override public String getInternalSubset()
	{
	...
	@Override public NamedNodeMap getNotations()
	{
