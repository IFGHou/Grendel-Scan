...
public class HTMLTableRowElementImpl extends HTMLElementImpl implements HTMLTableRowElement
{
	...
	public HTMLTableRowElementImpl(int transactionId)
	{
		super("TR", true, transactionId);
	}
	
	public HTMLTableRowElementImpl(String name, int transactionId)
	{
	...
	@Override public HTMLCollection getCells()
	{
	...
	@Override public HTMLElement insertCell(int index) throws DOMException
	{
