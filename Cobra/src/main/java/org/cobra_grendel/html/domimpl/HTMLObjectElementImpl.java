...
public class HTMLObjectElementImpl extends HTMLAbstractUIElement implements HTMLObjectElement
{
	...
	public HTMLObjectElementImpl(String name, int transactionId)
	{
	...
	@Override public String getCodeBase()
	{
	...
	@Override public boolean getDeclare()
	{
	...
	@Override public String getStandby()
	{
	...
	@Override public void setArchive(String archive)
	{
	...
	@Override public void setCodeBase(String codeBase)
	{
	...
	@Override public void setDeclare(boolean declare)
	{
	...
	@Override public void setHspace(int hspace)
	{
	...
	@Override public void setStandby(String standby)
	{
	...
	@Override public void setVspace(int vspace)
	{
