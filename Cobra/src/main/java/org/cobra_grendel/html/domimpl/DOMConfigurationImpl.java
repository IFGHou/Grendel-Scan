...
public class DOMConfigurationImpl implements DOMConfiguration
{
	...
	@Override public boolean canSetParameter(String name, Object value)
	{
		// TODO
		return true;
	}
	
	@Override public Object getParameter(String name) throws DOMException
	{
		synchronized (this)
		{
	...
	@Override public DOMStringList getParameterNames()
	{
		synchronized (this)
		{
