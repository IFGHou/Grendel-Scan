...
public abstract class DbJob<T> extends SQLiteJob<T>
{
    ...
    protected DbJob(final String query, final Object[] values)
    {
        this.query = query;
        this.values = values;
    }

    protected void handleBindings(final SQLiteConnection connection) throws SQLiteException, IOException
    {
