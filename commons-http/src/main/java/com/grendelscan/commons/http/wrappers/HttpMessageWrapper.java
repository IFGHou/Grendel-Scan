...
{
    private static final Logger LOGGER = LoggerFactory.getLogger(HttpMessageWrapper.class);
	/**
	 * 
	 */
	...
	protected byte[] getBytes()
	{
		...
		{
			LOGGER.error("Weird problem getting bytes from message wrapper: " + e.toString(), e);
		}
