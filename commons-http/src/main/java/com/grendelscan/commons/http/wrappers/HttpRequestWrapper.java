...
public class HttpRequestWrapper extends HttpMessageWrapper
{
	...
	@Override public byte[] getBytes()
	{
		...
		{
			LOGGER.error("Weird problem getting bytes from request wrapper: " + e.toString(), e);
		}
	...
	public HttpHost getHttpHost()
	{
		...
		if (networkPort == 0)
		{
			...
			{
				LOGGER.error("Very weird problem getting port number from URL", e);
			}
		}
	...
	public String getHost()
	{
		...
		if (host == null || host.isEmpty())
		{
			...
			{
				LOGGER.trace("No host defined. Unusual, but could be true");
			}
		}
		return host;
	}
...
//	
	...
	public void setURI(final String uri, boolean adjustToRelativeURI)
	{
		if (adjustToRelativeURI)
		{
			...
			{
				LOGGER.error("Illegal URL syntax: " + e.toString(), e);
